...
final class LevelDatasource({
  required final SharedPreferencesAsync sharedPreferences,
  final GameResultCodec gameResultCodec = const GameResultCodec(),
}) implements ILevelDatasource {
  ...
  Future<void> runMigration() async {
    ...
    for (final dictionary in dictionaries) {
      try {
        ...
        await sharedPreferencesColumnJson(dictionary.languageCode)
