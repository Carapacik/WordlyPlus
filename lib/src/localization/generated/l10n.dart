...
class GeneratedLocalizations {
  ...
  /// `Hard Mode`
  String get hardMode {
    return Intl.message('Hard Mode', name: 'hardMode', desc: '', args: []);
  }
  ...
  String get hardModePosition {
    return Intl.message(
      'Keep revealed correct letters in their positions.',
      name: 'hardModePosition',
      desc: '',
      args: [],
    );
  }
  ...
  String get hardModeMissingLetters {
    return Intl.message(
      'Use all revealed letters, including repeated letters.',
      name: 'hardModeMissingLetters',
      desc: '',
      args: [],
    );
  }
