const Map<String, String> dictionaryEn = {
  ...
  "agave":
      "A plant that grows in the hot, dry parts of the southern US and South America. There are many different types of agave and the plants have thick long or rounded leaves with sharp points on them, and tall flowers.",
  ...
  "alkyl":
      "A group of atoms that consist of an alkane that has had one hydrogen atom removed; often used before another noun in the name of chemical substances",
  ...
  "alnco": "ALNCo is short for Additional Learning Needs Coordinator. ",
  ...
  "amide":
      "A substance formed from ammonia by replacing a hydrogen atom with a metal",
  "amigo": "A friend; used especially by or of a Spanish-speaking person",
  "amine":
      "Any of a group of substances formed from ammonia by replacing hydrogen atoms with a group of atoms containing carbon",
  "amiss": "Wrong, not suitable, or not as expected",
  "amity": "A good relationship",
  "amnia":
      "A bag made of thin skin that contains amniotic fluid and surrounds the embryo of a mammal, bird, or reptile inside its mother",
  ...
  "angus":
      "An area of northeastern Scotland that was a county until 1975 and is now a council area (= an area with its own local government)",
  "anime":
  ...
  "anode":
      "One of the electrodes (= objects that electricity moves through) in a piece of electrical equipment. The anode is the negative electrode in a battery and the positive electrode in an electrolytic cell.",
  ...
  "arian":
      "A person born during the period 21 March to 20 April, who is believed to be influenced by the zodiac sign Aries",
  "aries":
      "A small constellation (= a group of stars) said to look like a ram (= a male sheep with horns)",
  "arise": "To happen",
  ...
  "aryan":
      "Belonging or relating to a group of people who invaded northern India about 4,000 years ago and spoke an Indo-European language",
  ...
  "baddy": "A bad person in a film, book, etc.",
  "badge":
  ...
  "bagsy":
      "To claim the right to have or do something because you said you wanted it first",
  "bails":
  ...
  "baker":
      "A person whose job is to make bread and cakes for sale, or to sell bread and cakes",
  "baldy":
  ...
  "bandh":
      "An occasion when offices, businesses, schools, etc. close for a day and people stop working in order to show that they disagree with something or to show respect",
  "bandy": "(of legs) bending out at the knees",
  "bangs":
  ...
  "basal": "Forming the bottom layer of something",
  "bases":
  ...
  "basil": "A herb with a sweet smell that is used to add flavour in cooking",
  "basin":
  ...
  "bated": "In an anxious (= worried and nervous) or excited way",
  "bathe": "To swim, especially in the sea, a river, or a lake",
  "batik":
  ...
  "batty": "Silly and slightly crazy and behaving in a confused way",
  "baulk": "Balk",
  ...
  "beaut": "Something that, or someone who, is very good or noticeable",
  "beaux": "A boyfriend",
  ...
  "began": "To start to happen or exist",
  "beget": "To be the father of",
  "begin": "To start to happen or exist",
  ...
  "belle": "A beautiful and attractive woman or one who is beautifully dressed",
  "belly":
  ...
  "benny":
      "A pill containing Benzedrine, which is a type of amphetamine (= a drug that makes the mind or body more active)",
  "bento":
      "A Japanese-style packed lunch (= a light meal that you take to eat at work or school), usually in a special box with separate parts or containers inside it",
  ...
  "besan":
      "A type of flour made from chickpeas (= hard light-brown round beans)",
  "beset":
  ...
  "bevel": "A sloping edge",
  "bevvy": "An alcoholic drink",
  "bezel":
      "The plastic front cover of a computer that can be removed and is designed to make the computer look more attractive",
  "bhaji":
      "A spicy South Asian dish made of vegetables, flour, egg, and water, formed into a round shape and fried in oil",
  "bible":
  ...
  "bight": "A curved part of a coast or river that is set back from the rest",
  "bigot":
      "A person who has strong, unreasonable beliefs and who does not like other people who have different beliefs or a different way of life",
  "bijou": "(especially of a building) small but attractive",
  "biked": "A bicycle",
  "biker": "A member of a group of people riding motorcycles",
  "bikie": "A member of a group of people riding motorcycles",
  "bilby":
      "A type of marsupial that lives in Australia and that looks like a rat with grey fur and long ears",
  "bilge": "Nonsense",
  ...
  "bindi":
      "A small coloured mark or jewel (= precious stone) that is worn between the eyebrows, especially by Hindu women to show that they are married",
  "binge":
  ...
  "blond": "(esp. of hair) pale yellow or golden",
  "blood":
  ...
  "bodge": "To spoil something by doing it badly",
  "bogan":
  ...
  "boggy": "Boggy ground is soft and wet.",
  "bogie":
      "A low framework on wheels, put under another vehicle such as a rail carriage so it can move",
  "bogof":
      "Abbreviation for buy one get one free: used in shops to mean that if you buy something, you get another of the same thing for no extra cost",
  "bogus": "False, not real, or not legal",
  "bokeh": "A blurred (= not clear) effect used in photography",
  ...
  "boner": "An erection (= an occasion when a man's penis is hard)",
  "bongo": "One of a pair of small drums that are played with the hands",
  ...
  "booby": "A type of seabird similar to a gannet",
  "books":
  ...
  "booze": "Alcohol",
  "boozy": "Drinking or containing a lot of alcohol",
  "boppy": "Boppy music is good for dancing to",
  "borax": "A white powder used to make glass and cleaning products",
  "bored":
      "Feeling unhappy because something is not interesting or because you have nothing to do",
  "borer": "An insect that makes holes in plants, wood, etc.",
  ...
  "bosky": "Attractively covered with trees",
  "bosom": "A woman's breast or breasts",
  "boson": "A type of subatomic particle",
  "bossy": "A bossy person is always telling people what to do",
  "bosun": "A boatswain",
  "botch": "To spoil something by doing it badly",
  "bothy":
      "(in Scotland) a small, simple building on a hill for walkers to shelter in, or one that is used on a farm for workers to live in",
  "botox":
  ...
  "bower": "A pleasant place under the branches of a tree in a wood or garden",
  "boxed":
      "A square or rectangular container with stiff sides and sometimes a lid",
  "boxer": "Someone who takes part in the sport of boxing",
  "braai":
      "A meal prepared on a barbecue (= a metal frame for cooking over a fire) and eaten outside",
  "brace":
      "Something that is used to support or connect things, or to make something stronger",
  "bract":
      "A type of leaf that grows from the area just below a flower and is sometimes different in shape or colour from the main leaves",
  "braid":
  ...
  "bream":
      "A type of fish that can be eaten, found especially in lakes and rivers",
  "breed":
      "To keep animals for the purpose of producing young animals in a controlled way",
  "breve": "A musical note with a time value equal to two semibreves ",
  "briar":
  ...
  "brier": "A briar",
  "brill": "Informal for brilliant UK informal ",
  ...
  "briny": "Briny water contains a lot of salt.",
  "brisk": "Quick, energetic, and active",
  "broad": "Very wide",
  "broch":
      "A prehistoric (= from an ancient time before there were written records) round stone tower in northern Scotland",
  "broil": "To cook something under a very hot surface in a cooker",
  "broke":
      "To (cause something to) separate suddenly or violently into two or more pieces, or to (cause something to) stop working by being damaged",
  ...
  "bruit": "To tell everyone a piece of news",
  "brume": "Fog or mist (= thin fog)",
  ...
  "brute": "A rough and sometimes violent man",
  "bubba":
      "Sometimes used to address or refer to a boy or a man, especially the eldest child in a family",
  "buddy": "A friend",
  "budge":
  ...
  "bugle":
      "A musical instrument like a simple trumpet, used especially in the army",
  "build": "To make something by putting bricks or other materials together",
  "built": "To make something by putting bricks or other materials together",
  ...
  "burly": "A burly man is large and strong",
  "burma": "A country in Southeast Asia, whose official name is Myanmar",
  "burnt":
      "To be hurt, damaged, or destroyed by fire or extreme heat, or to cause this to happen",
  "burqa": "A burka",
  "bursa":
      "A sac (= part of the body like a bag) that is filled with fluid and protects tissue from injury due to friction",
  "burst": "To break open or apart suddenly, or to make something do this",
  "busby": "A fur hat worn by some British soldiers for formal ceremonies",
  "buses":
      "A large vehicle in which people are driven from one place to another",
  "bushy": "Bushy hair or fur is very thick",
  "busty": "A busty woman has large breasts.",
  "butch":
  ...
  "butty": "A sandwich",
  "buxom": "(of a woman) healthy-looking and slightly fat, with large breasts",
  "buyer": "Someone who buys something expensive such as a house",
  "buzzy":
      "Exciting, especially because a lot of people are present and a lot of things are happening",
  "bylaw":
      "A law made by local government that only relates to its particular region",
  "byway": "A small road that not many cars or people travel on",
  "cabal":
  ...
  "caddy": "A small container",
  "cadet": "A student in the armed forces or the police",
  "cadge": "To (try to) get something from someone else without paying for it",
  "cadre":
  ...
  "cagey": "Unwilling to give information",
  "cairn":
  ...
  "cairo":
      "The capital city of Egypt, situated in the northern part of the country on the river Nile",
  "cajun":
      "A person who lives in the US state of Louisiana and whose relations in the past were French-speaking Canadians",
  "caked": "(of a surface) covered with a thick layer of something",
  "cakey": "Similar to a cake in how it feels, looks, or tastes",
  "calve": "When a cow calves, it gives birth to a calf (= a young cow)",
  "calyx":
      "The outer part of a flower formed by the sepals (= the separate outer parts), which covers and protects the petals, etc. as they develop",
  "camel":
  ...
  "carat": "A unit for measuring the weight of jewels (= precious stones)",
  "cards": "Any game played with cards, such as poker or bridge",
  "cardy": "Informal for cardigan",
  "cared":
      "The process of protecting someone or something and providing what that person or thing needs",
  "carer": "Someone who takes care of a person who is young, old, or sick",
  ...
  "carob": "(the dark brown seeds that are like beans of) a Mediterranean tree",
  "carol": "A happy or religious song, usually one sung at Christmas",
  "carom": "To hit something and bounce back, especially at an angle",
  "carpi":
  ...
  "cased": "Covered in a tight case (= container or covering)",
  "caste":
  ...
  "cauda": "Any structure in the body that is like a tail",
  "caulk":
  ...
  "caver": "A person who walks and climbs in caves as a sport",
  "cavil":
      "To make unreasonable complaints, especially about things that are not important",
  "cavum":
      "A Latin word meaning \"cavity\" (= a hollow space in an organ, etc.), used in the names of parts of the body",
  ...
  "chain": "A set of connected or related things",
  "chair":
  ...
  "chaps":
      "Leather clothing worn over trousers by cowboys to protect their legs when riding a horse, or by motorcyclists when riding a motorcycle, to protect their legs",
  "chard": "A vegetable with large, dark green leaves and white stems",
  "charm":
  ...
  "chewy": "Chewy food needs to be chewed a lot before it is swallowed",
  ...
  "chips": "Potato chip",
  "chirp": "(especially of a bird) to make a short high sound or sounds",
  "chive":
      "Relating to or containing chives (= leaves used in cooking to give aflavour similar to onions)",
  "chock":
  ...
  "chuff":
      "To make a sound like the sound of someone blowing out air quickly and forcefully, or like the sound a steam engine makes",
  ...
  "cifas":
      "An organization whose purpose is to prevent the crime of fraud in the UK financial system. The organization used to be called the Credit Industry Fraud Avoidance System",
  "cigar": "A tube made from dried and rolled tobacco leaves that people smoke",
  "cilia":
      "One of the very small parts like hairs on the surface of a cell that move regularly and keep the surrounding liquid moving around it or help an organism with only one cell to move",
  "cinch":
      "Something that is very easy and is therefore certain to be a success",
  "cipfa":
      "Abbreviation for the Chartered Institute of Public Finance and Accountancy",
  "circa": "(used especially with years) approximately",
  "cisco":
      "Abbreviation for City Group for Smaller Companies: an organization in the UK that represents smaller companies whose shares are publicly traded",
  "cissy":
  ...
  "civet": "A small animal like a cat from Africa and southern Asia",
  ...
  "clean": "Free from any dirty marks, pollution, bacteria, etc.",
  ...
  "cleft": "An opening or crack, especially in a rock or the ground",
  "clerk":
  ...
  "cline":
      "A scale (= set of numbers, levels, etc.) on which things can be arranged in order according to a particular feature or quality",
  "cling":
  ...
  "clomp": "To walk with heavy, loud steps",
  "clone":
  ...
  "clout": "To hit someone or something with the hand or with a heavy object",
  "clove":
  ...
  "clubs":
      "One of the four suits (= groups) of playing cards, the symbol for which is a black sign with three circular parts and a stem",
  "cluck": "To make the low, interrupted noise that a chicken makes",
  "clump": "A group, especially of trees or flowers",
  "clung":
      "To stick onto or hold something or someone tightly, or to refuse to stop holding it, him, or her",
  "clunk": "A deep low sound made by two heavy objects hitting each other",
  "clwyd":
      "An area of northeastern Wales that was a county (= an area with its own local government) from 1974 to 1996",
  "coach":
  ...
  "cobol": "A computer language designed for business managers",
  "cobra":
  ...
  "codon":
      "A set of three nucleotides that together form a unit of genetic code in a DNA or RNA molecule",
  "coley":
      "A fish that lives in the North Atlantic, or the flesh of this fish eaten as food",
  "colic":
      "A severe but not continuous pain in the bottom part of the stomach or bowels, especially in` babies",
  "colla":
      "A Latin word meaning \"neck\", used in descriptions of the neck and parts of the body that are like the neck",
  "colli":
      "A Latin word meaning \"of the neck\", used in the names of some parts of the body, for example the longus colli muscle",
  "colon":
      "The lower and bigger half of the bowels in which water is removed from solid waste",
  "color": "Red, blue, green, yellow, etc.",
  "combi": "A kombi",
  "combo": "A small group of musicians who play dance and jazz music",
  "comer": "Someone who arrives somewhere",
  "comet":
  ...
  "comex": "The part of the New York Mercantile Exchange that trades in metals",
  ...
  "comms":
      "Short form of communications: used to refer to methods of sending messages, especially long-distance methods such as radio, telephone, and internet, and to the messages themselves",
  "comps": "Abbreviation for comparable-store sales",
  "conch":
      "A large spiral shell, or the tropical snail-like sea creature that lives in it",
  "condo": "A condominium",
  "coney": "A rabbit, or the fur of a rabbit",
  "conga":
  ...
  "contd": "Written abbreviation for continued",
  ...
  "coped": "To deal successfully with a difficult situation",
  "copse": "A small group of trees",
  "coral":
      "A substance like rock, formed in the sea by groups of particular types of small animal, often used in jewellery",
  "cored": "The basic and most important part of something",
  "corgi":
      "A breed of dog with a long, strong body, short legs, and a pointed nose",
  "cornu":
      "Any part of the body that is shaped like a horn (= a hard curved part on the heads of some animals)",
  "corny":
  ...
  "could": "To say words aloud; to speak to someone",
  "count":
  ...
  "couth":
      "(of a person or their behaviour) polite and with a pleasant appearance",
  ...
  "coyly": "In a way that intentionally tries to keep something secret",
  "coypu": "A South American animal that lives near water and has valuable fur",
  "cozen": "To trick or deceive someone",
  "crack":
  ...
  "crass": "Stupid and without considering how other people might feel",
  "crate":
  ...
  "crema":
      "A thin layer of light-brown foam (= small bubbles) that forms on the top of some types of strong coffee",
  ...
  "crier": "A town crier",
  "cries": "Third person singular of cry",
  ...
  "croat": "A person from Croatia",
  "crock": "A container, usually one made of clay",
  "croft":
  ...
  "crore": "Ten million",
  "cross": "To go across from one side of something to the other",
  "croup":
      "A children's illness in which a child has noisy, difficult breathing and coughs a lot",
  ...
  "crypt": "A room under the floor of a church where bodies are buried",
  "cuban": "Belonging to or relating to Cuba or its people",
  "cubby": "A very small room or space for storing things",
  "cubed": "A solid object with six square sides of equal size",
  "cubic":
      "Used in units of volume to show when the length of something has been multiplied by its width and height",
  "cuffs": "Short form ofhandcuffs",
  "cumin":
  ...
  "cupid": "A model or painting of a little boy looking like Cupid",
  "cuppa": "A cup of tea",
  "cured": "To make someone with an illness healthy again",
  "curia":
      "The government and court of the Roman Catholic Church, with the Pope in the highest position",
  "curie": "A unit, used especially in the past, for measuring radioactivity",
  ...
  "curva": "A curved arrangement of seats in many Italian football stadiums",
  "curve": "A line that bends continuously and has no straight parts",
  "curvy": "Containing a lot of curves",
  "cushy": "Very easy",
  "cutie": "Someone who you consider attractive or like a lot",
  "cutis":
      "The layer of skin under the epidermis (= the thin outer layer of skin), used in the names of some medical conditions",
  "cutup":
  ...
  "cyton":
      "The central part of a neuron (= a cell that sends and receives messages within the brain and nerves)",
  "czech":
      "Belonging to or relating to the Czech Republic, its people, or its language",
  "daddy": "Child's word for father",
  "daffy": "Strange or unusual, sometimes in a humorous way",
  "daggy": "Untidy or dirty",
  ...
  "dalit":
      "(in the former caste system in South Asia) a member of the lowest caste",
  ...
  "darky":
      "An extremely offensive word for a person who has black or brown skin",
  "darts":
      "A game in which darts are thrown at a circular board, scoring the number of points marked on the board",
  "dashi":
      "A type of stock (= a liquid used to add flavour to food) that is used in Japanese cooking, made with fish and seaweed",
  "dated": "Old-fashioned",
  ...
  "davos":
      "A town in Switzerland where the World Economic Forum is usually held every year. The WEF is a meeting for discussions between business people, economists, politicians, etc.",
  "dazed": "Very confused and unable to think clearly",
  "dealt": "An agreement or an arrangement, especially in business",
  ...
  "debug": "To remove bugs (= mistakes) from a computer program",
  "debut":
      "The occasion when someone performs or presents something to the public for the first time",
  "decaf":
      "Having had some or all of the caffeine (= a chemical substance that makes you feel more awake) removed; short for decaffeinated ",
  "decal":
  ...
  "decor": "The colour, style, and arrangement of the objects in a room",
  "decoy":
  ...
  "deffo": "Informal for definitely ",
  "defog":
      "To remove the mist (= thin layer of water drops) from the window of a car, usually by blowing air over it",
  ...
  "demat":
      "Used to describe shares, etc. that are dematerialized (= bought, sold, and stored electronically), rather than being sold, etc. in the form of certificates (= paper documents)",
  "demit":
      "To give up a job or position by telling your employer that you are leaving",
  "demob": "Informal for demobilize formal",
  ...
  "depot": "A building where supplies or vehicles, especially buses, are kept",
  "depth":
  ...
  "derny":
      "A bicycle with a motor, used to set the pace (= speed) in some bicycle racing events such as the keirin",
  "destn": "Abbreviation for destination",
  "deter":
  ...
  "dicky":
      "Weak, especially in health, and likely to fail or suffer from problems",
  "dicot": "A plant that has two cotyledons (= leaf parts inside the seed)",
  "dicta":
  ...
  "dinar":
      "The standard unit of money used in various countries in Western Asia and North Africa",
  "dined": "To eat the main meal of the day, usually in the evening",
  ...
  "ditsy":
      "Printed with an irregular-looking pattern of small flowers or shapes",
  "ditto":
  ...
  "ditzy": "A ditzy person, especially a woman, is silly",
  "divan":
      "A long, comfortable seat for more than one person that has no back or arms",
  "diver":
      "A person who dives as a sport, or who works or searches for things underwater using special breathing equipment",
  "divot":
  ...
  "djinn": "A jinn",
  "dodge": "To avoid being hit by something by moving quickly to one side",
  "dodgy": "Dishonest",
  "doggo": "To keep still and hide so that you cannot be found",
  "doggy": "A dog",
  "dogie": "A calf (= young cow) that has no mother",
  "dogma":
  ...
  "doing": "To be done or caused by someone",
  "dolby":
      "A brand name for an electronic system for reducing unwanted noise on sound recordings",
  "dolly": "A doll (= a toy in the shape of a small person or baby)",
  "dolus":
      "A trick or false statement that has the intention of deceiving someone",
  "domed": "Shaped like a dome or covered with a dome",
  "donee":
      "A person or organization that receives something of value such as money or goods",
  "donga": "A type of ditch (= long, narrow, open hole in the ground)",
  "donor":
      "A person who gives some of their blood or a part of their body to help someone who is ill",
  "donut": "A doughnut",
  "dooce":
      "To lose your job because you have written something bad about it on a blog",
  "doomy":
      "Creating a mood that is sad and without hope, as if something very bad is going to happen",
  "doona":
      "A brand name for a large, soft, flat bag filled with feathers or artificial material, used on a bed",
  "doozy": "Something special or unusual, especially something unusually bad",
  "dopey": "Wanting to sleep, because or as if you have taken a drug",
  "doric":
      "Of or copying the simplest of the classical styles of ancient Greek building",
  "dorky": "Physically or socially awkward or not fashionable",
  "dorsa":
      "A Latin word meaning \"back\", used in medical names and descriptions of the back or top surface of an organ",
  "dotty": "Slightly strange or mentally ill",
  "doubt":
  ...
  "dowel":
      "A rod, usually made of wood, that is used to hold two parts of something together by fitting into a hole in each part",
  "dower":
  ...
  "dozen": "Twelve",
  "dphil": "A PhD",
  "drabs": "In small amounts, a few at a time",
  "draft":
  ...
  "dreck": "Something of poor quality",
  "dregs":
  ...
  "drily": "Being funny in a way that is not obvious",
  "drink":
      "(an amount of) liquid that is taken into the body through the mouth",
  "drive":
  ...
  "dryly": "In an amusing but not obvious way",
  "dubai":
      "One of the seven emirates (= states ruled by an emir) that make up the United Arab Emirates",
  "ducal": "Of or connected with a duke",
  "duchy": "The area of land owned or ruled by a duke or duchess",
  "ducky": "A friendly way of talking to someone you like",
  "ducti":
      "A Latin word meaning \"duct\" (= a tube), used in medical names and descriptions",
  "dully": "In a way that is boring and not exciting",
  "dulse":
      "A type of seaweed (= a plant that grows in or near the sea) that can be eaten",
  "dummy":
      "A large model of a human, especially one used to show clothes in a shop",
  "dumpy": "Short and fat",
  "dunce": "A person who is slow to learn or stupid, especially at school",
  "dunno": "Short form of I don't know",
  "dunny": "Informal for toilet",
  "duped":
      "To deceive someone, usually by making that person do something that they did not intend to do",
  "durex": "A brand name for a type of condom",
  "durry": "A cigarette",
  ...
  "dwelt": "To live in a place or in a particular way",
  "dyfed":
      "An area of western Wales that was a county (= an area with its own local government) between 1974 and 1996",
  ...
  "eater":
      "Someone who eats a particular amount or type of food, eats in a particular way, or has a particular attitude towards food",
  ...
  "ebxml":
      "Abbreviation for Electronic Business using XML: a computer language for buying and selling over the internet",
  "edema":
      "An unhealthy condition in which liquid collects in the body tissues between the cells",
  "edged": "Having something around the edge",
  "edger":
  ...
  "educe": "To obtain information",
  "eejit": "An idiot; a stupid person",
  "eerie": "Strange in a frightening and mysterious way",
  "egret": "A large white bird with long legs that is a type of heron",
  ...
  "elfin": "Used to describe a person who is small and delicate",
  "elide":
  ...
  "elver": "A young eel (= a long, thin, snake-like fish)",
  "elves":
  ...
  "emmet":
      "A word used in some parts of the UK and Ireland to refer to an ant (= a small insect that lives under the ground in large, well-organized groups)",
  "emoji":
  ...
  "ended": "The part of a place or thing that is furthest away from the centre",
  "endow":
  ...
  "epoxy": "To stick things together using epoxy resin",
  ...
  "erase": "To remove something, especially a pencil mark by rubbing it",
  "erect": "To build a building, wall, or other structure",
  "erode": "To rub or be rubbed away gradually",
  "erred": "To make a mistake or to do something wrong",
  "error": "A mistake",
  "erupt":
  ...
  "essex": "A county (= area with its own local government) in eastern England",
  "ester":
      "A chemical compound produced by a reaction between an acid and an alcohol, in which the hydrogen of the acid has been replaced by an alkyl group of atoms ",
  "ether":
  ...
  "ethyl":
      "A chemical compound often used in producing biofuels (= fuels that are produced from plants, crops, waste, etc.)",
  "etyma": "A word or part of a word from which you get another word",
  "evade": "To avoid or escape from someone or something",
  "event": "Anything that happens, especially something important or unusual",
  "evert": "Turn something outwards or inside out",
  ...
  "extel":
      "A company that provides financial and business information, part of Thomson Financial",
  ...
  "eying": "One of the two organs in your face that are used for seeing",
  "eyrie":
      "The nest of an eagle or other large bird that eats meat, usually built in a high place that cannot be easily reached",
  "fable":
  ...
  "faded": "Less bright in colour than before",
  ...
  "farad":
      "A unit for measuring capacitance (= the ability of a system to store electrical charge)",
  "farce":
  ...
  "farro":
      "A type of wheat or spelt (= a grain used as food) that is sold dried, and cooked in liquid before eating",
  ...
  "fatwa": "An official statement or order from an Islamic religious leader",
  ...
  "fazed": "To surprise and worry someone",
  ...
  "fedex":
      "Another name for the company Federal Express, which delivers mail and goods",
  ...
  "femme": "(of a gay woman) behaving in a traditionally female way",
  ...
  "fetal": "Relating to a fetus (= a young human being or animal before birth)",
  "fetch":
  ...
  "fibor":
      "Abbreviation for Frankfurt Inter-Bank Offered Rate: the rate of interest at which German banks lent money to each other before the euro started to be used in 1999",
  "fibre":
      "Any of the thread-like parts that form plant or artificial material and can be made into cloth",
  "fibro": "A type of building material made from asbestos and cement",
  "field":
      "An area of land, used for growing crops or keeping animals, usually surrounded by a fence",
  "fiend": "An evil and cruel person",
  "fiery": "Bright red, like fire",
  ...
  "filer":
      "A person who is dealing with an official authority, especially a tax authority",
  "filet": "A piece of meat or fish without bones",
  "filly": "A young female horse",
  "filmy": "Very thin and often transparent",
  "filth": "Thick, unpleasant dirt",
  "final": "Last",
  "finch":
      "Any of various types of small singing bird with a short, wide, pointed beak",
  "fined": "Good or good enough; healthy and well",
  "finny":
  ...
  "firth": "A long strip of sea reaching into the land",
  ...
  "fixie":
      "Short for fixed-gear bike or fixed-wheel bike: a bicycle with only one gear (= a device that controls how much power goes to the wheels of a vehicle) that cannot move unless the pedals are being turned, often used for getting around a city",
  ...
  "flats": "Land that has no hills or mountains",
  "fleck": "A small mark or spot",
  "fleek": "Very attractive; as good as it could be",
  ...
  "flies": "A word or form that expresses more than one",
  "fling": "To throw something or someone suddenly and with a lot of force",
  "flint": "(a piece of) shiny grey or black stone that is like glass",
  "flirt":
  ...
  "floss": "A type of thread used for cleaning between the teeth",
  "flour":
  ...
  "fluky":
      "(of something good) happening as the result of chance instead of skill or planning",
  "flume":
      "A narrow channel made for carrying water, for example to factories that produce electricity",
  "flung": "To throw something or someone suddenly and with a lot of force",
  ...
  "flyer":
      "A small piece of paper with information on it about a product or event",
  "foamy": "Made of or producing a mass of very small bubbles",
  "focal": "Central and important",
  "focus":
      "The main or central point of something, especially of attention or interest",
  "foehn":
      "A warm, dry wind that blows from the south of a mountain range, especially the Alps",
  "fogey":
  ...
  "folks": "People, esp. those of a particular group or type",
  ...
  "fossa": "A natural hollow, especially in a bone",
  "found":
  ...
  "fount":
      "The person or place from which all information on a particular subject comes",
  "fovea":
      "A very small hollow in a bone or organ, especially in the macula of the eye",
  "foxed":
  ...
  "franc":
      "The standard unit of money used in France, Belgium, and Luxembourg before the introduction of the euro, and also used in Switzerland and in many African countries",
  "frank":
  ...
  "freed": "Not limited or controlled",
  ...
  "frier": "A fryer",
  "fries": "Long thin pieces of fried potato",
  "frill":
      "A long, narrow strip of cloth with folds along one side that is sewn along the edge of a piece of clothing or material for decoration",
  "frisk":
  ...
  "fritz": "Broken or not working",
  "frizz": "The quality of hair being frizzy",
  "frock": "A dress",
  ...
  "frosh":
      "Informal for freshman (= a first-year student in high school or college)",
  "frost":
  ...
  "froyo":
      "A very cold, sweet food made from frozen yogurt (= a slightly sour thick food made from milk, and often sugar and fruit)",
  "froze":
  ...
  "fryer": "A large deep pan in which food is fried",
  "fubar":
      "Extremely bad or certain to fail or be defeated or destroyed. Fubar is short for Fucked Up Beyond All Recognition",
  "fubsy": "Rather short and fat",
  "fudge": "A soft sweet made from sugar, butter, and milk",
  "fugal":
      "Similar to or relating to a fugue (= a piece of music with three or more tunes played together)",
  "fuggy":
      "Having air that is not pure, especially because of smoke, heat, or having a lot of people in a small space",
  "fugly": "Very ugly",
  "fugue": "A piece of music consisting of three or more tunes played together",
  "fully": "Completely",
  "fumed": "To be very angry, sometimes without expressing it",
  "fumes": "Strong, unpleasant, and sometimes dangerous gas or smoke",
  "fundi": "The lower part of an organ that is furthest from its opening",
  ...
  "furor": "A sudden excited or angry reaction to something by a lot of people",
  "furry": "Covered with fur",
  "furze": "A wild bush with sharp thorns and small, yellow flowers",
  "fused":
      "An electrical device or a piece of machinery that is fused has a fuse in it.",
  "fussy":
  ...
  "gamer": "Someone who likes playing computer games",
  ...
  "gappy": "With some teeth missing or with spaces between the teeth",
  "garda": "The police force of the Republic of Ireland",
  "gassy": "Containing a lot of gas",
  "gator": "Informal for alligator",
  ...
  "gauzy": "Made of a very thin, light cloth",
  "gavel":
  ...
  "gesso":
      "A mixture of plaster (= a substance that becomes hard and smooth as it dries) and glue, used in painting, sculpture, and as a base for decorating wood",
  "getup":
  ...
  "gilts": "Bonds that are sold by the British government",
  "gimme": "Short form of give me",
  "gipsy": "A gypsy",
  "girth":
      "The distance around the outside of a thick or fat object, like a tree or a body",
  "gismo": "Any small device with a particular purpose",
  "given": "Past participle of give",
  "giver": "A person who gives something to someone",
  ...
  "glans":
      "The head of the penis (= the male sexual organ) or the end of the clitoris (= part of the female sexual organs)",
  ...
  "glint": "To produce small, bright flashes of light reflected from a surface",
  "glitz":
  ...
  "gloop": "Any thick liquid or sticky substance",
  "glory": "Praise and thanks, especially as given to God",
  "gloss": "A smooth, shiny appearance on the surface of something",
  "glove":
  ...
  "glute": "Any of the large muscles in each buttock",
  "glyph":
      "A picture or symbol that represents a word, used in some writing systems, such as the one used in ancient Egypt",
  "gnarl": "A rough or twisted lump on a tree or piece of wood",
  "gnash": "To bring your top and bottom teeth together quickly",
  "gnome":
  ...
  "godly": "Obeying and respecting God",
  "gofer":
      "Someone whose job is to be sent to get and carry things such as messages, drinks, etc. for other people in a company",
  "gogga": "An insect of any type",
  "going": "How quickly you do something",
  "golds": "Shares in companies that produce gold",
  "golem":
  ...
  "gonad":
      "One of the organs in a male or female animal that produces sex cells",
  "goner": "A person or thing that has no chance of continuing to live",
  ...
  "goodo": "Informal for good",
  "goods": "Items for sale, or possessions that can be moved",
  "goody": "An object that people want or enjoy, often something nice to eat",
  ...
  "gorse": "A wild bush with sharp thorns and small, yellow flowers",
  "gotta": "Short form of have got to",
  "gouge": "To dig or cut into something in a rough or violent way",
  "gourd":
      "A large fruit that has a hard shell and cannot be eaten, or the shell of this fruit used as a container",
  "gouty":
      "Suffering from or relating to gout (= a painful diseases that makes the hands, feet, and knees swell)",
  ...
  "greek": "Belonging to or relating to Greece, its people, or its language",
  "green": "Of a colour between blue and yellow; of the colour of grass",
  "greet":
  ...
  "griot":
      "In parts of West Africa, someone who passes on their society's history, especially through stories, poems, and music, and who takes part in ceremonies such as weddings and funerals",
  "gripe": "A strong complaint",
  "grist": "Anything that can be used to your advantage",
  "grits":
      "A dried, crushed type of corn, usually boiled in water and eaten esp. for breakfast",
  ...
  "groin": "The place where your legs meet the front of your body",
  ...
  "grout": "To put a thin line of mortar in the spaces between tiles",
  ...
  "grunt": "(of a pig) to make a low, rough noise",
  "guano": "The excrement (= solid waste) of sea birds and bats",
  "guard":
  ...
  "gulch": "US for gully",
  "gules":
      "Used to describe something on a coat of arms (= a special shield or shield-shaped pattern that is the sign of a family, university, or city) that is red",
  "gully":
  ...
  "gusty": "With sudden, strong winds",
  "gutsy": "Brave and determined",
  "guyot": "A mountain under the sea with a flat top",
  "gwent":
      "An area in southeastern Wales that was a county (= an area with its own local government) from 1974 to 1996",
  "gyoza":
      "A Japanese food consisting of meat or vegetables wrapped in dough (= flour and water mixed together) and fried in oil",
  "gypsy":
  ...
  "gyrus": "One of the many rounded raised parts on the surface of the brain",
  "habit":
      "Something that you do often and regularly, sometimes without knowing that you are doing it",
  "hades":
      "In Greek mythology (= ancient stories), a place under the earth where the spirits of the dead go",
  "hadst":
      "In the past, the second person singular form of the past tense of \"have\"",
  ...
  "halal":
      "Used to refer to meat from an animal that has been killed in the way that is demanded by Islamic law, or someone who sells this meat",
  "hallo": "Used when meeting or greeting someone",
  "halva": "A sweet food made of crushed sesame seeds and honey",
  "halve":
  ...
  "hanky":
      "A handkerchief (= square piece of cloth or paper used for cleaning the nose and drying the eyes)",
  ...
  "hated": "Disliked very strongly and by many people",
  "hater":
  ...
  "haves": "The people who are not poor and the people who are poor",
  "havoc": "Confusion and lack of order, especially causing damage or trouble",
  "hazel": "A small tree that produces nuts that can be eaten",
  "heads":
  ...
  "heavy": "Weighing a lot, and needing effort to move or lift",
  "hedge":
  ...
  "hiked": "A long walk, especially in the countryside",
  "hiker": "A person who goes for a long walk in the countryside",
  "hilly": "Having a lot of hills",
  "hilum":
      "A hollow or narrow opening in an organ through which nerves, blood vessels, and tubes enter and leave",
  "hilus": "A hilum",
  "hindi":
  ...
  "hired": "To pay to use something for a short period",
  "hirer": "A person or company that employs people",
  "hispi":
      "A type of small, pale green cabbage (= a leafy vegetable) with a pointed end",
  ...
  "hoary": "Very old and familiar and therefore not interesting or funny",
  "hobby":
  ...
  "hokum":
      "A film, play, or television programme that does not show life as it really is",
  "holed":
  ...
  "holly":
      "A small evergreen tree (= one that never loses its leaves) with shiny, sharp leaves and small, round, red fruit. Holly is often used as a Christmas decoration in Europe and North America.",
  "homer":
      "A home run (= a point scored in baseball when you hit the ball and have time to run all the way around the four corners of the playing field before it is returned)",
  "homey": "A boy or man from your own town, or someone who is a close friend",
  "honed": "To make an object sharp",
  "honey": "A sweet, sticky, yellow substance made by bees and used as food",
  "honky": "A word used by some black people to refer to a white person",
  "honor": "A quality that combines respect, being proud, and honesty",
  "hooch": "Strong alcohol, especially whisky",
  "hooey":
      "Something that is not true or does not make sense, although some people may believe it",
  "hooky": "To stay away from school without permission",
  "hoped":
      "To want something to happen or to be true, and usually have a good reason to think that it might",
  "hoppy": "Like hops (= dried fruit used to make beer)",
  ...
  "huffy": "Angry and offended",
  "hullo": "Used when meeting or greeting someone",
  "human":
  ...
  "hunky": "A hunky man is sexually attractive and usually big and strong",
  "hunny":
      "Alternative spelling for honey: a way of speaking to someone you like or love, or someone who you want to be friendly to",
  "hurry":
  ...
  "hussy": "A woman or girl who is sexually immoral",
  "hutch":
      "A box made of wood with a wire front where small animals such as rabbits are kept",
  "hydel": "Indian English for hydroelectric ",
  "hydra":
  ...
  "hying": "To go quickly or to hurry",
  "hymen":
      "A thin piece of skin that partly covers the opening to a person's vagina",
  "hyoid":
      "A U-shaped bone in the middle of the neck between the chin and the thyroid that supports the tongue and tongue muscles",
  "hyped":
  ...
  "hypha":
      "Any of the parts like threads that form the body of a fungus (= for example a mushroom)",
  "ibiza": "The furthest west of the Balearic Islands, off the coast of Spain",
  ...
  "idaho": "A state in the northwest of the US, whose capital city is Boise",
  ...
  "idled": "Not working or being used",
  "idyll":
  ...
  "iliac":
      "Relating to the ilium (= the widest of the three bones that form the pelvis)",
  "ilium": "The widest of the three bones that form the pelvis",
  "image": "A picture in your mind or an idea of how someone or something is",
  "imbed": "To fix something firmly into a substance",
  ...
  "inbox": "A place on a computer where emails that are sent to you are kept",
  "incel":
  ...
  "indie":
      "An indie company, shop, or other business is small and not owned by a larger company; indie music, films, etc. are made by companies like this",
  "inept": "Not skilled or effective",
  "inert": "Not moving or not able to move",
  "infer":
      "To form an opinion or guess that something is true because of the information that you have",
  "ingot": "A piece of metal, usually in the shape of a narrow brick",
  "inked": "Coloured liquid used for writing, printing, and drawing",
  "inker":
  ...
  "inlay": "A decorative pattern put into the surface of an object",
  "inlet":
  ...
  "inset": "Something positioned within a larger object",
  "insta":
      "Short for Instagram : a social media service for sharing photographs and video",
  "intel":
  ...
  "ionic":
      "Relating to an atom or small group of atoms that has an electrical charge because it has added or lost one or more electrons",
  "iowan": "Someone from the US state of Iowa",
  "iraqi": "Belonging to or relating to Iraq or its people",
  "irate": "Very angry",
  "irish": "Belonging to or relating to Ireland, its people, or its language",
  "irked": "To annoy someone",
  "irony":
  ...
  "jacks":
      "A children�s game in which the player bounces a small ball into the air and tries to pick up a number of small metal or plastic objects with the same hand before catching the ball again",
  "jaded":
  ...
  "jawed": "The lower part of your face that moves when you open your mouth",
  "jazzy": "Very bright and colourful",
  "jeans":
      "Trousers made of denim (= strong blue cotton cloth) that are worn informally",
  "jelly":
      "A sweet soft food made by cooking fruit with sugar to preserve it. It is smooth, without any pieces of fruit in it. Jelly is eaten on bread",
  "jemmy":
  ...
  "jerky": "Meat that has been cut into long, thin strips and dried ",
  "jetty":
  ...
  "jewry": "All the Jews",
  "jibed": "An insulting remark that is intended to make someone look stupid",
  "jiffy": "A very short time",
  "jihad":
      "In Islam, a religious struggle against evil in yourself or in society",
  "jimmy":
      "A short, strong metal bar with a curved end, often used to force things open, for example by thieves to force open windows or doors",
  "jingo": "Used to express surprise or to emphasize a statement",
  "jived":
  ...
  "jokey": "Funny",
  "jolly": "Happy and smiling",
  "jones": "To want something very much",
  "joual": "A spoken form of the Canadian French language",
  "joule": "A unit of energy or work done",
  "joust":
  ...
  "juvie":
      "Short for juvenile detention centre: a type of prison for people who are not old enough to be considered as adults",
  "kabob": "A shish kebab",
  "kanji": "A Japanese writing system that uses Chinese symbols",
  "kapok":
      "A soft white material that is used as the filling in soft toys and cushions or for making a thick warm layer in clothes",
  "kappa": "The 10th letter of the Greek alphabet",
  "kaput": "Not working correctly",
  "karat": "A unit for measuring how pure gold is",
  "karma":
  ...
  "kasha": "Buckwheat (= a small, dark grain)",
  "katsu":
  ...
  "keeps": "For ever",
  "kefir":
      "A sour drink made from fermented milk, originally from Russia and Central Asia",
  "kendo":
      "A sport, originally from Japan, in which people fight using bamboo sticks",
  "kenya": "A country in East Africa",
  "keogh":
      "In the US, a type of saving or pension plan for self-employed people and small businesses that allows them to save an amount of their income before tax",
  "ketch":
      "A small sailing boat with two masts (= tall poles that support the sails)",
  ...
  "kippa":
      "A small, circular cover for the top of the head worn by Jewish men, especially at religious ceremonies",
  "kitty":
  ...
  "kneed": "The middle joint of the leg that allows the leg to bend",
  "kneel":
  ...
  "kofta":
      "A South Asian dish of balls of meat, cheese, or vegetables mixed with spices, or one of these balls",
  "kombi": "A vehicle like a small bus that can carry about ten people",
  "kombu":
      "A type of seaweed (= a plant that grows in the sea) that is commonly eaten in Japan",
  "kooky":
      "(especially of a person) strange in his or her appearance or behaviour, especially in a way that is interesting",
  "koori": "Another word for Aborigine , often used by Aborigines",
  "korai":
      "A type of ancient Greek statue of a young woman, standing up and dressed in long loose clothes",
  "korea":
      "A former country in East Asia that was divided into two parts in 1945 that later became the countries of North Korea and South Korea",
  "korma":
      "A South Asian dish that consists of meat, fish, or vegetables in a sauce made with cream or coconut",
  "kraut":
      "Short for sauerkraut: cabbage that has been cut into small pieces and preserved in salt",
  "krill":
      "Very small animals with a hard outer shell that live in the sea and are eaten in large numbers by some types of whale",
  "krona": "The standard unit of money used in Sweden and Iceland",
  "krone": "The standard unit of money used in Denmark and Norway",
  "kudos":
  ...
  "kurta":
      "A loose shirt without a collar, worn by women and men from South Asia",
  "label":
      "A piece of paper or other material that gives you information about the object it is attached to",
  "labia": "Folds on the outside of the female sex organs",
  "labii":
      "A Latin word meaning \"of the labium\" (= a lip or fold on the outside of the female sex organs), used in medical names and descriptions",
  "labor": "Practical work, especially when it involves hard physical effort",
  "labra": "A word for an edge or lip, used in descriptions of body parts",
  "laced":
  ...
  "lagan": "Goods or material from a ship found lying at the bottom of the sea",
  "lager":
  ...
  "laird": "A Scottish man who owns a large area of land",
  "lairy":
  ...
  "lathe":
      "A machine for changing the shape of a piece of wood, metal, etc. that works by turning the material while a sharp tool is pressed against it",
  "lathi":
  ...
  "latte": "A hot drink made from espresso (= strong coffee) and warm milk",
  "laugh":
  ...
  "laxly":
      "In a way that is not severe or strong enough, or shows little care, attention, or control",
  "layer":
  ...
  "lazed": "To relax and enjoy yourself, doing very little",
  "leach":
  ...
  "leafy": "A leafy place is pleasant and has a lot of trees",
  "leaky":
  ...
  "leccy": "Electricity, especially the supply of electricity to a home",
  ...
  "leeds": "A large city in northern England",
  "leery":
      "Not trusting someone or something and usually avoiding him, her, or it if possible",
  "lefty": "A person who uses their left hand to write, etc. with",
  "legal": "Connected with the law",
  "leggy": "A leggy woman or girl has long legs",
  "legit": "Allowed by law",
  "lemma":
      "A form of a word that appears as an entry in a dictionary and is used to represent all the other possible forms. For example, the lemma \"build\" represents \"builds\", \"building\", \"built\", etc.",
  ...
  "lenis": "(of a speech sound) made without a lot of force",
  "leper":
      "A person who is strongly disliked and avoided by other people because of something bad that he or she has done",
  "letch": "Informal for lecher disapproving",
  "letup": "The stopping or slowing down of something that is unpleasant",
  "levee":
  ...
  "liana": "A woody plant that grows in tropical forests",
  "libel":
  ...
  "libra":
      "A small constellation (= a group of stars) said to look like a pair of weighing scales",
  ...
  "liked": "To enjoy or approve of something or someone",
  "likes": "The things that you enjoy",
  "lilac": "A bush or small tree with sweet-smelling purple or white flowers",
  "limbo":
  ...
  "limey": "An insulting word for a British person",
  "limit":
      "The greatest amount, number, or level of something that is either possible or allowed",
  "linea":
      "A Latin word meaning \"line\" or \"stripe\", used in medical names and descriptions",
  "lined": "(of paper) having lines printed across it ",
  ...
  "links":
      "A large area of hills covered with sand near the sea, used for playing golf on",
  "linux":
      "The name of a program for operating a computer that users are allowed to change or improve as they choose",
  "lipid":
      "A substance such as a fat, oil, or wax that dissolves in alcohol but not in water and is an important part of living cells",
  "lippy": "Showing no respect in the way that you talk to someone",
  "lisle":
      "A type of cotton thread used especially in the past for making stockings, underwear, and gloves",
  "liter":
  ...
  "litre":
      "A unit for measuring the volume of a liquid or a gas, equal to 1,000 cubic centimetres",
  "lived": "(to continue) to be alive or have life",
  "liver":
  ...
  "loamy":
      "Consisting of or similar to loam (= high-quality earth that is a mixture of sand, clay, and decaying plant material)",
  ...
  "lobed":
      "(of a leaf) having rounded or pointed parts that stick out from the main part",
  "lobus":
      "A Latin word meaning \"lobe\" (= a part of an organ that seems to be separate from the rest), used in medical names and descriptions",
  "local":
  ...
  "login": "A name that you enter in order to be able to use a computer system",
  "loins": "The reproductive organs",
  "lolly": "An ice lolly UK or a lollipop",
  "loner": "A person who likes to do things on their own without other people",
  "longa": "A musical note with a time value equal to two or three breves",
  "longs":
      "UK government bonds that will be paid back more than 15 years in the future",
  "loony": "Silly or stupid",
  "loopy": "Strange, unusual, or silly",
  "loose": "Not firmly held or fastened in place",
  "loped": "(of a person or animal) to run taking long, relaxed steps",
  "lordy":
      "Used to express surprise, shock, or worry or to emphasize something",
  "loris":
      "A small primate (= a member of the most developed and intelligent group of mammals) that lives in trees in the forests of south and southeast Asia and is active at night. There are several species (= types) of loris",
  "lorry": "A truck ",
  "loser": "A person or team that does not win a game or competition",
  "lossy": "Involving the loss of data or of electrical energy ",
  "lotto":
  ...
  "lough": "In Ireland, a lake or an inlet",
  "louse":
  ...
  "lowed": "Not measuring much from the base to the top",
  ...
  "lubag":
      "A rare condition that is a combination of dystonia (= jerky movements of the arms and legs) and parkinsonism (= rigid muscle movement and shaking)",
  "lucid":
  ...
  "lungi":
      "A piece of clothing consisting of a piece of cloth wrapped around the waist and worn by men and women from South Asia",
  "lupin": "A garden plant with a long, pointed flower of various colours",
  "lupus":
      "A general name for various serious skin diseases that also affect the internal organs and bones",
  "lurch":
  ...
  "lurex":
      "A brand name for a type of thread that looks shiny, like metal, or cloth made from this thread",
  ...
  "lurve": "Love",
  "lusty": "Healthy, energetic, and full of strength and power",
  "luvvy":
      "An actor who speaks and acts in a very artificial and noticeable way",
  "lycra":
      "A brand name for a type of material that stretches, used especially for making clothes that fit very tightly",
  "lying": "To be in or move into a horizontal position on a surface",
  "lymph":
  ...
  "macaw":
      "A brightly coloured bird of the parrot family found in Central and South America",
  "macho":
  ...
  "madam": "A formal and polite way of speaking to a woman",
  "madly": "With a lot of energy and enthusiasm",
  "mafia":
      "A criminal organization that began in Sicily and is active in Italy and the US",
  "mafic":
      "Describes rocks containing more dark-colored substances and iron than other rocks",
  "magic":
      "The use of special powers to make things happen that would usually be impossible, such as in stories for children",
  "maine": "A state in the northeastern US, whose capital city is Augusta",
  "maize":
  ...
  "makar":
      "In Scotland, a poet given a special position by Parliament, who is asked to write poems about important public occasions in Scotland",
  "maker": "The people or company that make something",
  "malay": "A language spoken in Malaysia and Indonesia",
  ...
  "manly": "Having the qualities that people think a man should have",
  "manna":
      "(in the Bible) a food that dropped from heaven and prevented Moses and his people from dying of hunger in the desert",
  "manor":
  ...
  "manus":
      "A Latin word meaning \"hand\" or \"of the hand\", used in medical names and descriptions",
  "maori": "One of the original people of New Zealand and the Cook Islands",
  "maple":
  ...
  "mardy": "Angry and complaining; refusing to be pleasant to other people",
  "margo":
      "A Latin word meaning \"margin\" (= the outer part of something), used in medical names and descriptions",
  "marry":
  ...
  "mbira": "A thumb piano",
  "mbyte": "Written abbreviation for megabyte",
  "mccoy": "The original or best example of something",
  "mealy": "Dry and like a powder",
  "means": "A method or way of doing something",
  "meant":
      "To express or represent something such as an idea, thought, or fact",
  "meany": "A meanie child's word",
  "meaty": "Full of meat or tasting strongly like meat",
  "mecca": "The holy city of Islam in Saudi Arabia",
  "medal":
  ...
  "medic": "A medical student or doctor",
  "melee":
  ...
  "merch": "Informal for merchandise formal ",
  "mercy":
  ...
  "metho": "Informal for methylated spirits UK",
  "meths": "Informal for methylated spirits UK",
  "metre": "A unit of measurement equal to 100 centimetres",
  "metro": "An underground electric railway system in some cities",
  "mewed": "The soft crying sound that a cat makes",
  "miami": "A large city in the southeastern US state of Florida",
  "miaow": "The high crying sound of a cat",
  "micro": "Informal for microcomputer",
  "midas":
      "If someone has the Midas touch, that person is financially successful in everything they do.",
  "middy": "A beer glass of medium size, containing 285 ml",
  "midge": "A small fly that flies in groups, and often bites",
  ...
  "milky": "A milky liquid contains milk or is made with a lot of milk",
  "mimed":
  ...
  "mined": "The one(s) belonging to or connected with me",
  "miner": "A person who works in a mine",
  "minge": "Offensive for a woman's genitals or vagina",
  ...
  "minky":
      "A brand name for a type of cloth made of polyester (= artificial material) that is thick and soft, with one side like short fur, and that is often used for making clothes, especially for children",
  "minor":
      "Having little importance, influence, or effect, especially when compared with other things of the same type",
  "minty":
      "Tasting or smelling of mint (= a herb with a strong, fresh flavour)",
  "minus": "Reduced by a stated number",
  "mired":
      "To be involved in a difficult situation, especially for a long period of time",
  "mirin": "Sweet Japanese wine made from rice, used in cooking",
  ...
  "miter": "A tall, pointed hat worn by bishops in official ceremonies",
  "mitre": "A tall, pointed hat worn by bishops in official ceremonies",
  "mixed": "Showing a mixture of different feelings or opinions",
  "mixer": "A machine that mixes substances",
  "mngmt": "Written abbreviation for management ",
  "mocha": "A type of coffee of good quality",
  "mochi":
      "A type of rice used in Japanese cooking, which is sweet with short, rounded seeds that stick together when cooked",
  "modal":
  ...
  "moggy": "A cat, especially one that is ordinary or has an untidy appearance",
  "mogul": "An important person who is very rich or powerful",
  "moire":
      "Cloth, especially silk, with a pattern on the surface that looks similar to waves on water",
  "moist": "Slightly wet, especially in a good way",
  "molal":
      "Of, containing, or relating to a solution that has one mole of solute in every 1,000 grams of solvent.",
  "molar":
      "One of the large teeth at the back of the mouth in humans and some other animals used for crushing and chewing food",
  "moldy": "Covered with mould",
  "momma": "Informal for mother",
  "mommy": "Child's word for mother",
  "money":
  ...
  "moobs":
      "Fat on a man�s chest that makes it look as if he has a woman�s breasts",
  ...
  "mooed": "The sound that a cow makes",
  "mooli": "A type of white radish popular in China and Japan",
  "moose":
  ...
  "mossy": "Covered with moss (= a small plant that grows in wet places)",
  "motel":
  ...
  "mousy": "Mousy hair is brown and not special or attractive.",
  "mouth":
  ...
  "mphil":
      "Abbreviation forMaster of Philosophy: an advanced college or university degree in any subject, or a person who has this degree",
  "mucky": "Dirty",
  "mucus":
  ...
  "mulga": "A type of tree found in dry regions, or its wood",
  "mummy": "Child's word for mother",
  "mumps":
      "An infectious disease that causes painful swelling in the neck and slight fever",
  "mumsy":
      "A mumsy woman has an old-fashioned appearance, like that of a traditional mother",
  "munch": "To eat something, especially noisily",
  "munro":
      "A mountain in Scotland that is higher than 3000 feet (914.4 metres) ",
  "mural":
  ...
  "mushy": "Soft and having no firm shape",
  "music":
  ...
  "muzzy":
      "(of a person) confused and unable to think clearly because of tiredness, illness, alcohol, or drugs, or (of a situation, plans, etc.) not clear or well explained",
  "mylar":
      "A brand name for a type of very thin polyester (= a kind of plastic), used to wrap and protect things, as insulation, and for of its shiny quality",
  "mynah": "A black or dark brown bird from Asia that can copy human speech",
  "myrrh":
  ...
  "nacho":
      "A small piece of fried tortilla (= flat bread made from maize flour), often eaten with melted cheese or a dip",
  "nacre":
  ...
  "named": "The word or words that a person, thing, or place is known by",
  "nancy":
      "An offensive word for a gay man or a man who is considered to be effeminate",
  "nanny":
      "A person whose job is to take care of a particular family's children",
  "nappa": "A soft type of leather made from the skin of sheep or goats",
  "nappy":
  ...
  "natal": "Relating to where a person or animal was born",
  "natch": "Naturally; as you would expect",
  "natto":
      "A Japanese food made from soya beans that has a strong smell and taste and is often eaten for breakfast",
  ...
  "nelly": "There is no possibility of that",
  ...
  "nervi":
      "A Latin word meaning \"nerve\" or \"group of nerves\", used in medical names and descriptions",
  "nervy": "Worried",
  "never": "Not at any time or not on any occasion",
  "newly": "Recently",
  "newsy": "Containing a lot of news that is personal or not very serious",
  "nexus":
  ...
  "niffy": "Having an unpleasant smell",
  "nifty": "Good, pleasing, or effective",
  "niger": "A country in west Africa",
  "nigga":
      "A way of saying or writing nigger (= an extremely offensive word for a black person)",
  "night":
  ...
  "ninth": "9th written as a word",
  "nippy": "Able to change speed and direction easily",
  "niqab":
      "A piece of cloth worn by some Muslim women to cover the whole face except the eyes",
  "nival": "(of an area) always covered in snow",
  "nixed": "To stop, prevent, or refuse to accept something",
  "nobel":
  ...
  "nobly": "In a way that is morally good, brave, honest or kind",
  "nodal":
      "Consisting of or relating to a place where a leaf and stem join a plant",
  ...
  "nooch":
      "A type of yeast used in vegan cooking (= cooking that does not use any animal products) to improve the taste of other foods",
  "nooky": "Sex",
  "noose":
      "One end of a rope tied to form a circle that can be tightened round something such as a person's neck to hang (= kill) them",
  "norse":
      "Belonging or relating to the people who lived in Scandinavia in the past, especially the Vikings",
  "north":
  ...
  "noted": "Known by many people, especially because of particular qualities",
  "novae":
  ...
  "nucha":
      "A Latin word meaning \"the nape (= back) of the neck\", used in medical names and descriptions",
  "nudge":
  ...
  "nuked": "To bomb somewhere with nuclear weapons",
  "nurse":
  ...
  "oasis":
      "A place in a desert where there is water and therefore plants and trees and sometimes a village or town",
  "oater":
      "A western (= a film based on stories about life in the west of the US in the past)",
  ...
  "ocher":
      "A yellowish-orange color, or a substance obtained from earth that is used for giving this color to paints",
  "ochre":
  ...
  "ofcom":
      "Abbreviation for Office of Communications: an official UK organization that checks that telephone and broadcasting companies obey government rules",
  "offal":
  ...
  "offie": "An off-licence UK",
  "ofgem":
      "Abbreviation for Office of the Gas and Electricity Markets: an official organization in the UK that checks whether gas and electricity companies are obeying government rules",
  "oftel":
      "Abbreviation for Office of Telecommunications: an official organization in the UK that has been replaced by Ofcom. It checked whether phone and broadcasting companies were obeying government rules.",
  "often": "Many times",
  "ofwat":
      "Abbreviation for Water Services Regulation Authority: an official organization in the UK that checks whether water companies are obeying government rules",
  "ogled": "To look at someone with obvious sexual interest",
  "oiled":
      "Petroleum (= the black oil obtained from under the earth's surface from which petrol comes)",
  "okapi":
      "An African animal, related to the giraffe, that is mainly brown with stripes of black and white around its legs and back part",
  "okker": "An ocker Australian English informal",
  "olden": "From a long time ago",
  "oldie": "An old popular song",
  "olive":
  ...
  "ology":
      "A subject that is studied at school, college, or university and is thought to need a large amount of special knowledge",
  "omani": "Belonging to or relating to Oman or its people",
  ...
  "oomph": "Power, strength, or energetic activity",
  "oozed":
  ...
  "opium":
      "A drug made from the seeds of a poppy (= red flower) that is used to control pain or to help people sleep. It can make a person who takes it want more of it and is sometimes used by people as an illegal drug for pleasure",
  "opted":
      "To make a choice, especially of one thing or possibility instead of others",
  "optic": "Relating to light or the eyes",
  "oracy": "The ability to speak clearly and grammatically correctly",
  "orbit":
  ...
  "other": "As well as the thing or person already mentioned",
  "otter":
  ...
  "ounce": "A unit of weight equal to approximately 28 grams",
  "outdo": "To be, or do something, better than someone else",
  "outed": "Used to show movement away from the inside of a place or container",
  "outer": "At a greater distance from the centre",
  "outta": "Out of",
  "ovary":
      "Either of the pair of organs in a woman's body that produce eggs, or the part of any female animal or plant that produces eggs or seeds",
  "ovate": "Shaped like an egg",
  "overt": "Done or shown publicly or in an obvious way and not secret",
  "ovine": "Relating to sheep",
  "ovoid": "Having the same shape as an egg, or of a similar shape",
  "ovule":
      "A part inside the ovary (= organ that produces eggs) of a plant that contains the female sex cell and develops into a seed when that cell is fertilized",
  ...
  "oxfam":
      "A UK-based organization that works to help people who are extremely poor and suffering by, among other things, collecting old clothes and other unwanted things and selling them at low prices in special shops",
  "oxide": "A chemical combination of oxygen and one other element",
  "oxter":
      "A person's armpit (= the hollow place under your arm where your arm joins your body )",
  "ozone": "A poisonous form of oxygen",
  "paced":
      "The speed at which someone or something moves, or with which something happens or changes",
  "paddy": "A very angry state",
  "padel":
      "A type of tennis played on a small court surrounded by a net or walls, usually by two teams of two people",
  "padre": "A Christian priest, especially in the armed forces",
  "paean":
  ...
  "pains": "To try very hard to do something",
  "paint":
      "A coloured liquid that is put on a surface such as a wall to decorate it",
  "paisa":
      "A unit of money in India, Pakistan, and Nepal worth one hundredth of a rupee, or a coin of this value",
  "paise":
      "A unit of money in India, Pakistan, and Nepal worth one hundredth of a rupee, or a coin of this value",
  "palau": "A country formed of over 200 islands in the Pacific Ocean",
  "paled":
  ...
  "paleo":
      "Relating to or typical of the ancient period when people used tools and weapons made of stone",
  "pally": "Friendly",
  "panda":
  ...
  "panir": "A soft cheese from South Asia, often made in the home",
  "panko":
      "A type of breadcrumbs (= very small pieces of dried bread), originally made in Japan, used to make a crispy (= pleasantly hard) covering around fried food",
  "pansy":
  ...
  "pappy": "Pappy food is unpleasantly soft or contains too much water",
  ...
  "parky": "(of weather or the conditions in a room) quite cold",
  "parry":
  ...
  "parsi":
      "A member of a religious group found mainly in western India, whose religion, zoroastrianism, started in Persia (ancient Iran)",
  "party":
  ...
  "patsy": "A person who it is easy to cheat or make suffer",
  "patty": "A piece of food made into a disc shape that is then cooked",
  "pause":
  ...
  "paver":
      "A flat piece of stone, usually used in groups to cover a path or an area",
  "pawed":
  ...
  "payor": "A person who pays something",
  "peace":
  ...
  "pedis":
      "A Latin word meaning \"of the foot\", used in medical names and descriptions",
  ...
  "penis": "The part of a male's body that is used for urinating and for sex",
  "penne": "A type of pasta in the shape of tubes",
  "penny":
      "The smallest unit of money in the UK, of which there are 100 in a pound, or a small coin worth this much. You use \"pence\" or, more informally, \"p\" when you are talking about the units of money and pennies when you are talking about the coins themselves",
  "peony": "A garden plant with large red, pink, or white flowers",
  "peppy": "Having a lot of energy or activity",
  ...
  "perry": "An alcoholic drink made from pears",
  "pervy":
      "(of sexual behaviour or interests) considered strange and unpleasant by most people",
  "pesky": "Annoying or causing trouble",
  "pesto": "A green sauce used in Italian cooking, especially on pasta",
  "petal":
  ...
  "phage":
      "Short for bacteriophage; a virus that grows and divides inside a bacterium, destroying it ",
  "phase": "Any stage in a series of events or in a process of development",
  "phial": "A small glass bottle, especially one containing liquid medicine",
  "phone":
  ...
  "piker": "A person who avoids getting into difficult or dangerous situations",
  "pikey": "An insulting word for a gypsy",
  "pilaf": "Rice cooked in spicy liquid, often with vegetables or meat added",
  "pilau": "Rice cooked in spicy liquid, often with vegetables or meat added",
  "piled": "Objects positioned one on top of another",
  ...
  "pinko": "A person who (slightly) supports socialist ideas and principles",
  "pinny": "Informal for pinafore UK",
  "pinta": "A pint of milk",
  "pious":
      "Strongly believing in religion, and living in a way that shows this belief",
  "piped": "A tube inside which liquid or gas flows from one place to another",
  "piper":
      "Someone who plays a pipe (= a short narrow tube played by blowing through it) or the bagpipes",
  "pique":
      "A feeling of anger, especially caused by someone damaging your feeling of being proud of yourself",
  "pissy": "Annoyed, especially when you show this in your behaviour",
  "piste": "A snow-covered area or track that is suitable for skiing",
  "pitch":
      "An area painted with lines for playing particular sports, especially football",
  "pithy": "(of speech or writing) expressing an idea cleverly in a few words",
  "piton":
  ...
  "pitta": "Flat, hollow bread in an oval shape",
  ...
  "plica": "A fold or ridge in the skin",
  "plied":
  ...
  "plume": "A large feather",
  "plump": "Having a pleasantly soft, rounded body or shape",
  "plunk": "To put something down heavily and without taking care",
  "pluot":
      "A trademark for a fruit that is a hybrid (= a mixture of two different types of plant or animal) of a plum and an apricot, and is more similar to a plum",
  "plush": "Soft to touch",
  "pluto":
  ...
  "pocky":
      "(of skin or people) covered in spots or pockmarks (= marks left by spots)",
  "podgy": "Slightly fat",
  "podia":
  ...
  "podos":
      "A Greek word for \"of the foot\", used in descriptions of parts of the body",
  ...
  "polar": "Relating to the North or South Pole or the areas around them",
  "polio":
  ...
  "polyp": "A small, simple, tube-shaped water animal",
  "ponce":
      "A man who controls prostitutes and takes a large part of the money that they earn for himself",
  "poncy":
      "An insulting way of describing something that is not traditionally male, especially in behaviour, appearance, or speech",
  "ponte":
      "A type of cloth used for making clothes that is similar to thick jersey (= soft thin cloth, usually made from wool, cotton, or silk)",
  "pooch": "A dog",
  "pooed": "(a piece of) solid waste from the body",
  "poppy":
      "A plant with large, delicate flowers that are typically red and have small, black seeds",
  "popsy": "A young and attractive woman",
  ...
  "posey":
      "Expensive and fashionable, in a way that is intended to make other people feel admiration",
  "posho": "A person from a high social class, especially one who is annoying",
  "posit":
      "To suggest something as a basic fact or principle from which a further idea is formed or developed",
  "posse": "A group of people who have come together for the same purpose",
  "potty": "Silly or slightly crazy",
  "pouch":
      "A bag or soft container for a small object or a small amount of something",
  "poult": "A young chicken, turkey, or other bird that is kept for food",
  ...
  "powys":
      "A county (= an area with its own local government) in central eastern Wales",
  "prang": "To damage a vehicle slightly in a road accident",
  "prank":
  ...
  "pried": "To try to find out private facts about a person",
  ...
  "prism":
      "A solid shape with flat sides and two ends that are the same shape ",
  "privy": "To be told information that is not told to many people",
  "prize":
  ...
  "promo": "A short film made to advertise a product, especially a pop song",
  "prone":
  ...
  "pronk":
      "(used of a springbok (= a Southern African mammal like a deer) or similar animal) to jump high in the air with straight legs and a curved back",
  "proof":
      "A fact or piece of information that shows that something exists or is true",
  "props": "Respect for someone",
  "prose": "Written language in its ordinary form rather than poetry",
  "prosy":
      "Similar to or relating to prose (= written language in its ordinary form rather than poetry)",
  "proud":
  ...
  "psoas":
      "One of the two muscles on each side of the body that go from each side of the spine to the top of the thigh bone",
  "psych":
  ...
  "pubes": "One of the three main bones of the pelvis",
  "pubic": "Of or near the sexual organs on the outside of a person's body",
  "pubis": "One of the three main bones of the pelvis",
  "pudgy": "Slightly fat",
  "puffy": "If the skin around your eyes is puffy, it is slightly swollen",
  "puked": "To vomit",
  "pukka": "Real",
  "pulpy":
  ...
  "pupae":
      "An insect in the stage of development after it has been a larva and before it becomes an adult, during which it is contained in and protected by a hard covering and does not move",
  "pupal":
      "Relating to a pupa (= an insect in the stage of development when it is inside a hard covering, before it becomes an adult)",
  ...
  "pzazz": "The quality of noticeable and energetic excitement",
  "qatar": "A country in Western Asia",
  "quack": "To make the usual sound of a duck",
  ...
  "queer": "(especially of a man) gay",
  "quell": "To stop something, especially by using force",
  "quern":
      "A simple device for grinding grain (= making it into a powder) between two heavy stones",
  "query":
  ...
  "quill": "Any of the long sharp pointed hairs on the body of a porcupine",
  "quilt": "A decorative cover for a bed",
  "quire": "Four sheets of paper folded to make 16 pages",
  "quirk":
      "An unusual habit or part of someone's personality, or something that is strange and unexpected",
  "quite": "Completely",
  "quits": "To not owe money to someone or to each other now",
  "quoll":
  ...
  "quorn":
      "A brand name for a substance made of vegetable protein that is used in cooking instead of meat",
  ...
  "racer": "A person or thing that races",
  "radar":
  ...
  "radix": "The beginning part of an organ in the body",
  "radon":
      "A chemical element that is a radioactive gas formed when radium decays and found naturally in rock and soil",
  "raged": "(a period of) extreme or violent anger",
  "ragga":
      "A type of music that combines elements of reggae, rap, and dance music, mostly played by Afro-Caribbean people",
  "rainy": "Raining a lot",
  "raise": "To lift something to a higher position",
  "raita":
      "A South Asian dish consisting of yogurt with very small pieces of raw (= not cooked) vegetables mixed in",
  "rajah": "A male Indian ruler",
  "raked": "Sloping",
  "rally":
      "A public meeting of a large group of people, especially supporters of a particular opinion",
  "rambo":
      "Someone who uses, or threatens to use, strong and violent methods against their enemies",
  "ramen":
      "A Japanese meat or fish soup containing noodles (= long thin strips made from flour, water, and egg) and vegetables",
  "ramus": "The main part of a branch of nerves or blood vessels",
  "ranch":
      "A very large farm on which animals are kept, especially in North and South America",
  "rando": "An unknown or unexpected person",
  ...
  "raphe": "A place or line where two halves of an organ in the body join",
  "rapid": "Fast or sudden",
  "raspy": "A raspy voice sounds unpleasantly rough.",
  "rasul":
      "A type of beauty treatment in which your body is covered with special mud (= earth mixed with water), you go into a room full of steam, and then the mud is washed off; the room in which this is done",
  "rated":
  ...
  "raver":
      "Someone who goes to a rave (= an event where young people dance to modern electronic music and sometimes take illegal drugs)",
  "rayon": "A smooth cloth used to make clothes",
  "razed": "To completely destroy a city, building, etc.",
  "razor":
  ...
  "recon": "Informal for reconnaissance specialized",
  "recto": "The front of something that is printed on both sides",
  "recur": "To happen many times or to happen again",
  "redox":
      "A chemical process in which an atom, molecule, etc. either gains or loses electrons",
  "redux": "(often used in the titles of films and video games) brought back",
  "reedy": "A reedy place has many reeds (= tall plants like grass)",
  "reeve": "A legal officer in England in the past",
  "refit":
  ...
  "regal": "Very special and suitable for a king or queen",
  "regio":
  ...
  "rekey": "To put information into a computer again using a keyboard",
  "relax": "To (cause someone to) become less active and more calm and happy",
  "relay":
  ...
  "reply": "To answer",
  "reran": "To show a television programme, film, etc. again",
  "rerun": "To show a television programme, film, etc. again",
  "resat":
  ...
  "resit":
      "To take an exam again, usually because you failed or did not do well the first time",
  "resus": "Short for resuscitation: the act of bringing someone back to life",
  "retch": "To react in a way as if you are vomiting",
  "retia":
      "A Latin word meaning \"network\", usually referring to a network of blood vessels",
  "retro": "Similar to styles, fashions, etc. from the past",
  "retry":
      "To try someone again in a court of law (= examine them to find out if they have committed a crime or not)",
  "reuse": "To use something again",
  "revel":
      "To dance, drink, sing, etc. at a party or in public, especially in a noisy way",
  "revex": "Abbreviation for revenue expenditure",
  "revue":
      "A show with songs, dances, jokes, and short plays often about recent events",
  "rhino": "A rhinoceros",
  "rhyme": "Words that rhyme have the same last sound",
  "riced":
      "Separated into very small pieces that look like rice by being forced through small holes in a special tool",
  "ricer":
      "A special tool that separates food into very small pieces that look like rice, by forcing it through small holes",
  "ricin": "A poisonous powder obtained from the bean of the castor oil plant",
  "rider": "A person who travels along on a horse or bicycle",
  "ridge":
  ...
  "riled": "Angry because of something someone has done or said",
  "rinse": "To use water to clean the soap or dirt from something",
  "rioja": "A type of Spanish wine",
  "ripen": "To (cause to) become ripe",
  "risen": "Past participle of rise",
  "riser": "A person who usually gets out of bed early/late in the morning",
  ...
  "roach": "A European fish that lives in fresh water",
  "roast": "To cook food in an oven or over a fire",
  "robed": "To be dressed in a particular way",
  "robin":
  ...
  "rocks": "Having serious difficulties and likely to fail soon",
  "rocky":
  ...
  "roman":
      "Roman letters are in the ordinary style of printed writing in which the letters are vertical.",
  "romeo":
      "A man who thinks he is attractive to women and has sexual relationships with many women",
  "rondo":
      "A piece of music that repeats the main tune several times and often forms part of a longer piece",
  "roomy":
  ...
  "roped": "(a piece of) strong, thick string made of long twisted threads",
  "rosin":
  ...
  "ruche": "A tight fold in a piece of cloth, used as a decoration",
  "ruddy": "Red",
  "rugby":
  ...
  "ruing": "To feel sorry about an event and wish it had not happened",
  "ruled":
  ...
  "rumba": "A type of dancing, originally from Cuba, or the music for this",
  "rummy":
      "Any of various card games in which two or more players try to collect cards that have the same value or whose numbers follow an ordered series",
  "rumor":
  ...
  "rupee":
      "The standard unit of money used in India, Pakistan, Mauritius, Nepal, Sri Lanka, and the Seychelles",
  "rural": "In, of, or like the countryside",
  "rusty": "Covered with rust (= metal decay)",
  "saber":
  ...
  "sabre":
      "A heavy sword with a wide, usually curved blade, used in the past by soldiers on horses",
  "sacra":
      "A triangle-shaped bone at the base of the lower back above the coccyx (= a small bone at the base of the spine)",
  "saddo":
      "Someone, especially a man, who is not fashionable or interesting or has no friends",
  "sadhu":
      "A Hindu holy man, especially one who has chosen to live apart from society",
  "sadly": "In an unhappy way",
  "saggy": "Hanging or dropping down to a lower level",
  "saint":
  ...
  "samey": "Not interesting because of being very similar",
  "samoa": "A country formed of a group of islands in the Pacific Ocean",
  "sandy": "Covered with sand or containing sand",
  "sappy":
      "Used to describe something that is extremely emotional in an embarrassing way",
  ...
  "satay":
      "A Southeast Asian food consisting of small pieces of meat or fish cooked on a stick, and served with a spicy peanut sauce",
  "sated": "Having had more of something than you can easily have at one time",
  "satin":
  ...
  "saudi": "Belonging to or relating to Saudi Arabia or its people",
  "sauna":
  ...
  "scarp": "A steep slope or cliff formed by folded or eroded layers of rock",
  "scary": "Frightening",
  "scene":
  ...
  "schmo": "A stupid or silly person",
  "scion": "A young member of a rich and famous family",
  "scoby":
      "A substance that is formed when bacteria and yeast ferment (= go through a process in which the sugar changes to acid, gas, or alcohol) used in the production of various types of food and drink ",
  "scoff":
  ...
  "scots": "Belonging to or relating to Scotland or its people",
  "scour":
  ...
  "scree":
      "Large, loose broken stones on the side of a mountain, or an area covered with stones like this",
  "screw":
  ...
  "scrim":
      "A type of cloth that is loosely woven (= the threads are not pulled tightly together)",
  "scrip":
      "Something that is not currency but that can be used in the same way as money, for example, points you collect when you shop at a particular store and gift certificates",
  "scrub":
  ...
  "scull":
      "A small oar (= pole with a flat end) used as one of a pair to move a small, light boat",
  "scurf": "Very small pieces of dry dead skin",
  "seamy":
  ...
  "sedge": "A plant like grass that grows on wet ground, often next to rivers",
  "seedy":
  ...
  "sehri":
      "The morning meal eaten by Muslims before the sun has come up during Ramadan (= the ninth month of the Muslim year, during which time Muslims have no food or drink during the day)",
  "seine":
  ...
  "senco":
      "A teacher who has responsibility for the children in a school who have special needs (= who need special care because of an illness or condition that makes it difficult for them to do the things that other people do). Senco is short for special educational needs coordinator. ",
  "sense":
  ...
  "seoul":
      "The capital city of South Korea, situated in the northwest of the country",
  "sepal":
      "One of the parts forming the outer part of a flower that surround the petals and are usually small and green",
  "sepia": "The reddish-brown colour of photographs in the past",
  "sepoy":
      "In the past, an Indian soldier who got his orders from a European officer",
  "septa":
      "A thin part dividing tissues or spaces in an organ such as the nose or heart",
  "serge":
      "A strong cloth made from wool, used especially to make jackets and coats",
  "serif":
      "A small line that is added to a printed letter in certain typefaces (= particular designs of letters and numbers)",
  "serum": "The thin yellowish liquid part of the blood ",
  "serve": "To provide food or drinks",
  "servo": "A service station (= a place where fuel is sold for road vehicles)",
  "setup":
      "An arrangement of things that allows something to happen, or the process that prepares this arrangement",
  "seven": "The number 7",
  "sever": "To break or separate, especially by cutting",
  "sewer":
  ...
  "shady": "Sheltered from direct light from the sun",
  "shaft": "A pole or rod that forms the handle of a tool or weapon",
  "shake":
  ...
  "shies": "Nervous and uncomfortable with other people",
  "shift":
  ...
  "shire":
      "A county, now used in combination in the names of many British counties",
  "shirk":
  ...
  "shogi":
      "A Japanese game played by two people using a square board, in which each player has 20 pieces that can be moved on the board in different ways",
  "shoji":
      "A sliding door made of white paper in a wooden frame, common in Japanese homes",
  "shone": "To send out or reflect light",
  "shook":
      "To move backwards and forwards or up and down in quick, short movements, or to make something or someone do this",
  "shoot":
  ...
  "shush": "Used to tell someone to be quiet",
  "shyer": "Comparative of shy",
  "shyly": "In a shy way",
  "sibyl":
      "Any of several women in the ancient world who were thought to be able to see into the future",
  "sicko":
      "Someone who behaves or thinks in a strange and unpleasant, often sexual, way",
  "sidle": "To walk towards or away from someone, trying not to be noticed",
  "siege":
  ...
  "sired": "A male parent of an animal, especially a horse",
  "siren": "A device for making a loud warning noise",
  "sisal":
      "(a tropical plant whose leaves produce) strong threads that are used for making rope and floor coverings",
  "sissy":
      "A boy who other boys dislike and laugh at because they think he is weak or interested in activities girls usually like, or a person who is weak and cowardly (= not brave)",
  "sitar":
      "A South Asian musical instrument with a round body, a long neck, and two sets of strings",
  "sited":
  ...
  "skate":
      "A special boot with a thin metal bar attached to the bottom that you wear to move quickly on ice, or a boot with four small wheels fixed to the bottom so that you can move over a hard surface",
  "skein":
  ...
  "skink": "A small lizard found in various hot parts of the world",
  ...
  "skive": "To be absent from work or school without permission",
  "skort":
  ...
  "skype":
      "A brand name for an application for communicating with other people over the internet using video or voice calls",
  "slack": "Not tight; loose",
  "slain": "Past participle of slay",
  "slake": "To satisfy a feeling of being thirsty or of wanting something",
  "slang":
  ...
  "slink": "To walk away from somewhere quietly so that you are not noticed",
  ...
  "slunk": "To walk away from somewhere quietly so that you are not noticed",
  "slurp":
      "To drink a liquid noisily as a result of sucking air into the mouth at the same time as the liquid",
  "slush": "Snow that is lying on the ground and has started to melt",
  "slyer": "Comparative of sly",
  ...
  "smarm":
      "To be extremely polite or helpful or show a lot of respect in a way that is annoying or does not seem sincere",
  "smart": "Having a clean, tidy, and stylish appearance",
  "smash": "To cause something to break noisily into a lot of small pieces",
  ...
  "smoko": "A short period when someone stops work to smoke a cigarette",
  "smoky": "If a place is smoky, there is a lot of smoke in it",
  "smote":
      "To hit someone forcefully or to have a sudden powerful or damaging effect on someone",
  "snack":
  ...
  "snout": "The nose and mouth that stick out from the face of some animals",
  "snowy": "Full of or like snow",
  "snuck":
      "To go somewhere secretly, or to take someone or something somewhere secretly",
  "snuff": "Tobacco in the form of a powder for breathing into the nose",
  "soapy": "Containing or like soap",
  "sober": "Not drunk or affected by alcohol",
  "softs":
      "A commodity product that is a crop, such as sugar or coffee, rather than one such as oil or coal",
  "soggy":
  ...
  "solei": "A muscle in the back of the leg, below the knee",
  ...
  "sonic": "Of sound or the speed at which sound travels in air",
  "sonny": "A form of address used by an older person to a boy or a young man",
  "sooth": "Used to show or emphasize that something is true",
  "sooty":
      "Covered in soot (= a black powder produced when coal, wood, etc. is burned)",
  "soppy":
  ...
  "sorta": "Short form of sort of",
  "sotho": "A group of people mainly living in Lesotho and South Africa",
  "sough":
  ...
  "spaff": "To waste money on something",
  "spain": "A country in western Europe",
  "spake":
  ...
  "spaza":
      "A small shop selling food, drinks, etc., especially one run from someone's home in a township",
  "speak":
      "To say words, to use the voice, or to have a conversation with someone",
  "spear":
  ...
  "spelt":
      "A type of grain that was an important source of food in ancient times",
  "spend": "To give money as a payment for something",
  "spent": "To give money as a payment for something",
  "sperm": "A sex cell produced by a man or male animal",
  "spice":
      "A substance made from a plant, used to give a special flavour to food",
  "spick": "(especially of a place) very clean and tidy",
  ...
  "spiff":
      "An amount of money paid by an employer or the manufacturer of a product to a sales person for selling a particular product",
  "spike":
  ...
  "spite": "(used before one fact that makes another fact surprising) despite",
  "splat":
      "The sound of something wet hitting a surface or of something hitting the surface of a liquid",
  "splay": "To spread wide apart",
  "split":
  ...
  "sprat": "A small sea fish that can be eaten",
  "spray": "A mass of very small drops of liquid carried in the air",
  "spree":
  ...
  "sprit":
      "A pole that is attached at an angle to a boat's mast (= main pole) and holds the highest point of a sail",
  "sprog": "A baby or young child",
  "sprue": "A condition where food is not absorbed into the body",
  "spume": "White foam (= bubbles) on the top of waves in water",
  ...
  "squab": "A young pigeon eaten as food",
  ...
  "squee": "To make a long, high sound because you are very happy or excited",
  "squib":
  ...
  "stagy": "Like in a theatre and not very natural",
  ...
  "stank": "To smell very unpleasant",
  "staph":
      "Short for staphylococcus : a type of bacterium that causes infection",
  "stare":
  ...
  "steak": "A thick, flat piece of meat or fish, especially meat from a cow",
  "steal":
  ...
  "stent":
      "A long thin object put inside a tube in the body, for example a blood vessel, so that its walls stay firm or so that body fluids can flow easily through it",
  ...
  "stole":
      "To take something without the permission or knowledge of the owner and keep it",
  "stoma":
      "One of the many pores (= very small holes in the surface) on a leaf or stem of a plant through which gases are able to pass in and out",
  "stomp":
  ...
  "stony": "Stony ground contains a lot of stones",
  "stood":
      "To be in a vertical state or to put into a vertical state, especially (of a person or animal) by making the legs straight",
  ...
  "stoup":
      "A bowl containing holy water, especially at the entrance to a Roman Catholic church ",
  "stout":
  ...
  "strep": "Informal for streptococcus specialized",
  "strew":
      "To spread things in an untidy way over a surface, or to be spread in an untidy way over a surface",
  "stria": "A stripe or line in body tissue, for example in muscles",
  "strip":
  ...
  "stuck": "A thin piece of wood or other material",
  "study":
  ...
  "stung":
      "If an insect, plant, or animal stings, it produces a small but painful injury, usually with a poison, by brushing against the skin or making a very small hole in the skin",
  "stunk": "To smell very unpleasant",
  "stunt":
  ...
  "stupa":
      "A building with a dome (= rounded roof), that is a holy place for Buddhists",
  "style":
  ...
  "sudsy": "Covered in soap bubbles",
  "suede": "Leather that is slightly rough to touch and is not shiny",
  "sufic":
      "Belonging to an Islamic religious group that tries to become united with God by living a simple life and praying and meditating; relating to this group",
  "sugar":
  ...
  "sulci":
      "A gap where the surface of a structure is folded, for example in the brain",
  "sulky":
      "Refusing to smile or be pleasant to people, usually because you are angry about something",
  "sully": "To spoil something that is pure or someone's perfect reputation",
  "sumac":
      "A large bush or small tree with leaves that are divided into several parts and fruits that grow in bunches (= groups)",
  "sunna":
      "A collection of traditional Muslim laws based on the prophet Muhammad's life and actions, used with the Koran to guide Muslims",
  "sunni":
      "(a member) of the largest Islamic religious group, which follows the teachings only of Mohammed, not those of any of the religious leaders who came after him",
  "sunny": "Bright because of light from the sun",
  "sunup": "The time in the morning when the sun starts to rise in the sky",
  "super": "Excellent",
  "supra": "Used in a text to refer to something mentioned earlier",
  "surae":
      "A Latin word meaning \"of the calf\" (= the back part of the leg below the knee), used in medical names and descriptions",
  "sural":
      "Of or relating to the calf (= the back part of the leg below the knee)",
  ...
  "swage":
      "A tool for pressing or hammering (= hitting) metal into a particular shape",
  "swain": "A young man who loves, or is having a relationship with, a woman",
  "swami": "(the title of) a Hindu religious teacher",
  ...
  "sward": "An area covered with grass",
  "swarf":
      "Extremely small pieces of metal, stone, etc., produced when a material is shaped or cut on a machine",
  "swarm": "A large group of insects all moving together",
  "swath": "A strip or belt, or a long area of something",
  "swazi": "Belonging to or relating to Swaziland, its people, or its language",
  "swear":
  ...
  "swiss": "Belonging to or relating to Switzerland or its people",
  "swizz": "Something that is disappointing or unfair",
  "swoon":
  ...
  "swung":
      "To move easily and without interruption backwards and forwards or from one side to the other, especially from a fixed point, or to cause something or someone to do this",
  "swype":
      "A way of entering text on a touchscreen by which you do not have to lift your finger off the screen between letters, only between words",
  "synod":
      "A regular meeting of Church members for the discussion of religious matters",
  "syria": "A country in Western Asia",
  "syrup": "A very sweet, thick liquid",
  ...
  "tache": "UK informal for moustache ",
  ...
  "tails": "The side of a coin that does not have an image of a head on it",
  "taint": "To spoil something or give it an unpleasant quality",
  "tajik": "Belonging to or relating to Tajikistan",
  "taken": "Past participle of take",
  "taker": "Someone who accepts or wants what someone is offering",
  "tally": "To match or agree with something else",
  "talon":
      "A sharp nail on the foot of a bird that it uses when hunting animals",
  "talus": "A bone forming part of the ankle joint",
  "tamed":
      "(especially of animals) not wild or dangerous, either naturally or because of training or long involvement with humans",
  "tamer": "Someone who tames something that is wild, especially an animal",
  "tamil":
      "Belonging to a group of people who form part of the population of Sri Lanka and also live in India and Southeast Asia",
  "tango":
      "An energetic dance from South America for two people, or the music for this dance",
  "tangy": "A tangy flavour is pleasantly strong and sharp",
  "tanka": "A short Japanese poem with 31 syllables",
  "tapas":
  ...
  "tapir":
      "An animal with hoofs, a long nose that bends, and a smooth coat, found in the forests of Southeast Asia and Central and South America",
  "tardy": "Slow or late in happening or arriving",
  "tarot":
  ...
  "tarsi": "The seven bones that form the ankle joint",
  "tarty":
  ...
  "telex":
      "A method of sending written messages down a phone line from one teleprinter to another, the machine that does this, or the message itself",
  "telly": "Informal for television",
  "tempi": "The speed at which an event happens",
  ...
  "tendo":
      "A tendon (= a strong piece of tissue connecting a muscle to a bone)",
  ...
  "teres": "One of two muscles that move the shoulders and arms",
  "terms":
      "The conditions that are part of an agreement or arrangement, or the features of an activity or idea",
  "terry":
      "A type of thick cotton cloth with short threads on each side, used especially for making towels (= thick cloths used for drying)",
  "terse": "Using few words, sometimes in a way that seems rude or unfriendly",
  "testa":
      "In plants with flowers, a hard layer that covers and protects the surface of a seed",
  "testy": "Easily annoyed and not patient",
  "texan": "Someone from the US state of Texas",
  "texas":
      "A state in the southern US on the coast of the Gulf of Mexico, whose capital city is Austin",
  "thane":
      "(in England at the time of the Anglo-Saxons) a man who was given land by the king or a military ruler and who held a rank above that of the common people",
  "thang":
  ...
  "therm": "A unit of heat used for measuring a gas supply",
  "these":
  ...
  "throw":
      "To send something through the air with force, especially by a sudden movement of the arm",
  "thrum": "To make a continuous low sound",
  "thumb":
      "The short, thick finger on the side of your hand that makes it possible to hold and pick things up easily",
  "thump": "To hit something and cause a noise",
  "thyme": "A herb used in cooking",
  "tiara":
      "A piece of metal in the shape of half a circle decorated with jewels (= precious stones) that is worn on the head by a woman, especially a queen, etc., at very formal social occasions",
  "tibet": "A region in East Asia",
  "tibia": "The large bone at the front of the lower leg",
  "tidal": "Relating to the tide",
  "tiger":
  ...
  "tikka":
      "In South Asian cooking, a mixture of spices and yogurt (= slightly sour, thick milk) used in preparing meat, cheese, etc. for some dishes and in the names of these dishes",
  "tilde":
      "(used when writing some languages) a ~ mark made above a letter, especially n, to show that the letter has a special sound",
  "tiled": "(of a surface) covered with tiles",
  ...
  "tincy": "Extremely small",
  "tinge": "A very slight amount of a colour or of a feeling",
  "tinny": "Tinny sound is of low quality or like metal being hit",
  ...
  "title": "The name of a film, book, painting, piece of music, etc.",
  "titty": "A tit",
  ...
  "tokyo":
      "A large city on Honshu island in Japan that is the capital of Japan",
  "tonal":
      "Relating to the quality of sound of a musical instrument or singing voice",
  "toned": "(of a body) firm and strong",
  "toner": "Ink for a printer or photocopier",
  "tonga":
      "A country in the southwest Pacific formed of over 150 small islands",
  "tongs":
  ...
  "tonne": "A unit of weight in the metric system, equal to 1,000 kilograms",
  "tooth":
      "One of the hard, white objects in the mouth that are used for biting and chewing (= crushing food)",
  "topaz": "A transparent, yellow stone used in jewellery",
  "topee": "A pith helmet",
  "topic": "A subject that is discussed, written about, or studied",
  "topos": "A traditional theme (= subject) that is found in literature",
  "toque":
  ...
  "torte": "A round, flat, sweet cake, often with cream and fruit",
  "total": "The amount you get when several smaller amounts are added together",
  "toted": "To carry something, especially something heavy or awkward",
  "totem":
      "An object that is respected by a group of people, especially for religious reasons",
  "totes": "Used as a short form of totally to emphasize what you are saying",
  "totty": "Sexually attractive people",
  "touch":
  ...
  "tranq":
      "A tranquillizer (= a drug used to make a person calmer, or to make an animal unconscious or calmer)",
  "trans":
      "Used to describe an isomer (= one of a group of similar chemical substances) in which the atoms are arranged on opposite sides of the molecule, especially on opposite sides of a carbon bond (= connected carbon atoms)",
  ...
  "tress": "A section or curl of someone's long hair",
  "trews": "Trousers",
  "triad":
  ...
  "tried": "To attempt to do something",
  "trier":
  ...
  "tromp":
      "A person with no home, job, or money who travels around and asks for money from other people",
  "tronc":
      "A system in which tips (= extra money that customers give) are collected together and shared out among all the staff in a restaurant",
  ...
  "tumid": "(of a part of the body) swollen, and larger in size than normal",
  "tummy": "The stomach, or the lower front part of the body",
  "tumor": "A mass of diseased cells that might become a lump or cause illness",
  "tuned": "Sloping and not flat",
  "tuner":
      "The part of a radio or television that allows you to choose the broadcasting station you want to listen to or watch",
  "tunic":
  ...
  "tuque":
      "A small wool hat, especially one with a tassel (= decoration made of a group of short threads)",
  "turbo":
      "Used to describe an engine or machine in which power is produced by a turbine",
  "tutor":
  ...
  "tweed": "A thick material made from wool of several different colours",
  "tween": "A child between the ages of approximately eight and twelve",
  "tweep": "Someone who uses the social media service Twitter � ",
  "tweet": "A short, high sound made by a bird",
  "twerk":
      "To do a style of dancing that involves bending low and moving the bottom and hips",
  "twerp": "A stupid person",
  "twice": "Two times",
  "twill":
      "A strong cotton cloth that has raised diagonal (= sloping) lines on the surface",
  "twine": "To (cause to) wrap round an object several times",
  "twink": "A gay man who is young, slim, and looks like a boy",
  "twirl": "To turn something quickly several times",
  "twirp": "A twerp old-fashioned informal",
  "twist":
  ...
  "ulnae": "A long, thin bone in the lower part of your arm",
  "ulnar":
  ...
  "unsee": "To return to a situation in which you have not seen something",
  "untie": "To unfasten a knot or something tied",
  "until": "Up to (the time that)",
  "unwed": "(used especially in newspapers) not married",
  "unzip": "To open something by using a zip",
  "upend":
  ...
  "utahn": "Someone from the US state of Utah",
  "uteri":
  ...
  "uvula": "The soft piece of flesh that hangs down at the back of the mouth",
  "uzbek":
      "Belonging to or relating to Uzbekistan, its people, or its language",
  "vacay": "A vacation",
  "vague": "Not clearly expressed, known, described, or decided",
  "vagus":
      "The nerve that supplies the heart, lungs, and most of the intestines",
  ...
  "vaper": "A person who vapes, especially by using e-cigarettes",
  ...
  "vedic": "Relating to the Veda (= one or all of the holy books of Hinduism)",
  "vegan":
      "A person who does not eat or use any animal products, such as meat, fish, eggs, cheese, or leather",
  "velar": "(of a consonant sound) made by the tongue touching the velum",
  "velum": "The soft area at the top in the mouth",
  "venae":
      "A Latin word meaning \"vein\" (= a tube that carries blood to the heart from other parts of the body), used in medical names and descriptions",
  "venal":
  ...
  "verso": "The back of something that is printed on both sides",
  "verve": "Great energy and enthusiasm",
  "vesta":
      "In Roman mythology (= ancient stories), the goddess (= female god) of the hearth (= the area around a fireplace in a house) and the home",
  "vexed":
  ...
  "villi":
      "One of many very small finger-like parts that are found on the inside surface of the small intestine and help food to be absorbed",
  "vinyl":
  ...
  "visor": "A part of a helmet that can be pulled down to cover the face",
  "vista": "A view, especially a beautiful view from a high position",
  "vital":
  ...
  "vivos": "Between living people",
  "vixen": "A female fox",
  "vocab": "All the words known and used by a particular person",
  "vocal":
      "Relating to or produced by the voice, either in singing or speaking",
  "vodka":
      "A clear, strong alcoholic drink made especially from grain or potatoes",
  ...
  "voile":
      "A thin cloth that you can almost see through, made from cotton, wool, or silk",
  "volar":
      "Relating to the palm of the hand (= the inside part) or the sole of the foot (= the bottom part that touches the floor)",
  "vomer":
      "A thin, flat bone that forms the nasal septum (= the part of the nose that separates the nostrils)",
  ...
  "vroom":
      "Used in writing to represent the sound of a car engine at high speed",
  "vulva": "The parts of the female sex organs that are outside the body",
  ...
  "wader":
      "A bird with long legs and a long neck, that lives near water and eats fish",
  "wadge": "A wodge UK informal",
  "wafer": "A very thin, dry biscuit that is often sweet",
  ...
  "wagyu":
      "Meat from a type of Japanese cow, also called Wagyu, that is very tender (= soft and easy to cut)",
  "wahoo":
  ...
  "waned": "To become weaker in strength or influence",
  "wanky": "Very stupid or very poor quality",
  "wanly": "In a way that shows no energy or enthusiasm",
  "wanna": "Short form of \"want to\" or \"want a\"",
  "wants": "Products and services that people want and need",
  "wares":
      "Small products for selling, especially in a market or on the street",
  "warty": "Having warts",
  "waspy": "Relating to or typical of a WASP (= White Anglo-Saxon Protestant)",
  "waste":
  ...
  "waxed":
      "Covered with a thin layer of wax, either to make something waterproof, or to improve its appearance ",
  "waxen": "A waxen face has pale, shiny skin and does not look healthy",
  "wazoo":
      "A person's bottom (= the part of the body you sit on) or anus (= the opening through which solid waste leaves the body)",
  ...
  "weedy": "Containing a lot of weeds",
  "weeny": "Extremely small",
  ...
  "welly": "Informal for wellington UK",
  "welsh": "Belonging to or relating to Wales, its people, or its language",
  "wench": "A young woman",
  "wetly": "In a way that involves water or another liquid",
  "whack": "To hit someone or something noisily",
  "whale":
      "A very large sea mammal that breathes air through a hole at the top of its head",
  "whang": "To hit or throw something using force",
  "wharf":
  ...
  "whirr": "(especially of machines) to make a low, soft, continuous sound",
  ...
  "white": "Of a colour like that of snow, milk, or bone",
  ...
  "widen": "To become, or to make something greater in width",
  "widow":
  ...
  "wight": "A ghost, or a dead person who has come back to life",
  "wilco":
      "Especially in communication by radio, used to say that you agree to do what is asked",
  "wiles": "Ways of persuading someone that trick them into doing something",
  "willy": "A willie",
  "wimpy": "Not strong, brave, or confident",
  "wince":
  ...
  "wiper": "Informal for windscreen wiper",
  "wired": "Connected to a computer or other device by a wire",
  "wisha": "An expression used to show surprise or to emphasize something",
  "wispy": "In the form of a wisp or wisps",
  "witch":
  ...
  "would": "Used to refer to future time from the point of view of the past",
  "wound":
      "A damaged area of the body, such as a cut or hole in the skin or flesh made by a weapon",
  "woven": "Past participle of weave",
  "wowed": "Used to show surprise and sometimes pleasure",
  "wrack":
  ...
  "xanax": "A brand name for a drug used to treat anxiety",
  "xenon":
  ...
  "xylem":
      "The type of plant tissue that carries water and minerals from the roots to the leaves and gives support to the stem or trunk",
  "yacht":
  ...
  "yakka": "Work",
  "yappy": "(of a dog) often making short high sounds",
  "yawed":
  ...
  "yemen": "A country in central Asia",
  "yield":
  ...
  "yonks": "A very long time, usually a number of years",
  ...
  "yukon":
      "A territory (= a large area of a country that has some local government but less independence than a province or a state) of northwestern Canada, whose capital city is Whitehorse",
  "yummy": "Tasting extremely good",
  "zaire": "A former name for the the Democratic Republic of the Congo",
  "zebra":
      "An African wild animal that looks like a horse, with black or brown and white lines on its body",
  "zelig":
      "A person who appears in many different situations and who changes their behaviour or appearance to suit the situation that they are in at the time",
  "zesty": "Full of flavour",
  "zhoug": "A spicy sauce containing chillies",
  "zhuzh":
      "To make something more interesting or attractive by changing it slightly or adding something to it",
  "zilch": "Nothing; none; no",
  "zingy": "Interesting and exciting",
  "zippy": "Energetic or fast",
  "zloty": "The standard unit of money used in Poland",
