...
/// For pagination.
final class ThrottleDroppableBlocTransformer<Event> extends BlocTransformer<Event> {
  ThrottleDroppableBlocTransformer([Duration? duration]) : _duration = duration ?? const Duration(milliseconds: 700);
