const Map<String, String> dictionaryEn = {
  ...
  'afaik':
      'As far as I know: used when you believe that something is true, but you are not completely certain',
  ...
  'again': 'One more time',
  'agape':
      'With the mouth wide open, especially showing surprise or shock; (of the mouth) wide open, especially in surprise or shock',
  'agate': 'A hard stone with strips of colour, used in jewellery',
  'agave':
      'A plant that grows in the hot, dry parts of the southern US and South America',
  ...
  'ahead': 'In front',
  'ahold': 'To get something / To find or communicate with someone',
  'aided': 'To help',
  ...
  'aired': 'To make opinions or complaints known to other people',
  ...
  'among': 'In the middle of or surrounded by other things / AMOGUS',
  'amped': 'Excited',
