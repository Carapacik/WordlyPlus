...
int get hashCode {
  final _this = this as GameState;
  return Object.hash(runtimeType,_this.dictionary,_this.secretWord,_this.gameMode,_this.gameCompleted,const DeepCollectionEquality().hash(_this.board),const DeepCollectionEquality().hash(_this.statuses),_this.lvlNumber);
}

@override
String toString() {
  final _this = this as GameState;
  return 'GameState(dictionary: ${_this.dictionary}, secretWord: ${_this.secretWord}, gameMode: ${_this.gameMode}, gameCompleted: ${_this.gameCompleted}, board: ${_this.board}, statuses: ${_this.statuses}, lvlNumber: ${_this.lvlNumber})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,dictionary,secretWord,gameMode,gameCompleted,const DeepCollectionEquality().hash(_board),const DeepCollectionEquality().hash(_statuses),lvlNumber);
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,dictionary,secretWord,gameMode,gameCompleted,const DeepCollectionEquality().hash(_board),const DeepCollectionEquality().hash(_statuses),error,lvlNumber);
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,dictionary,secretWord,gameMode,gameCompleted,const DeepCollectionEquality().hash(_board),const DeepCollectionEquality().hash(_statuses),lvlNumber,operation,pendingProgress,completedLevel,pendingIsWin,retryCount);
}
